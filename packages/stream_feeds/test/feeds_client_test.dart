...
//             (userId) async => UserToken(testUserToken),
//           ),
//         );
//
...
//         );
//
//         expect(client._feedsRepository, isNotNull);
//       });
//     });
//
//     group('apiClient', () {
...
//         );
//
//         expect(client._webSocketClient, isNotNull);
//       });
//     });
//
//     group('tokenManager', () {
...
//         );
//
//         expect(client._tokenManager, isNotNull);
//       });
//     });
//
...
//         client._webSocketClient.webSocketDidReceiveMessage(
