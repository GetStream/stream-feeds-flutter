...
mixin _$FeedListState {
  ...
  $FeedListStateCopyWith<FeedListState> get copyWith => _$FeedListStateCopyWithImpl<FeedListState>(
    this as FeedListState,
    _$identity,
  );
...
abstract mixin class $FeedListStateCopyWith<$Res> {
  factory $FeedListStateCopyWith(
    FeedListState value,
    $Res Function(FeedListState) _then,
...
/// @nodoc
class _$FeedListStateCopyWithImpl<$Res> implements $FeedListStateCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? feeds = null, Object? pagination = freezed}) {
    return _then(
      FeedListState(
        feeds: null == feeds
            ? _self.feeds
