...
mixin _$ActivityListState {
  ...
  $ActivityListStateCopyWith<ActivityListState> get copyWith => _$ActivityListStateCopyWithImpl<ActivityListState>(
    this as ActivityListState,
    _$identity,
  );
...
abstract mixin class $ActivityListStateCopyWith<$Res> {
  factory $ActivityListStateCopyWith(
    ActivityListState value,
    $Res Function(ActivityListState) _then,
...
/// @nodoc
class _$ActivityListStateCopyWithImpl<$Res> implements $ActivityListStateCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? activities = null, Object? pagination = freezed}) {
    return _then(
      ActivityListState(
