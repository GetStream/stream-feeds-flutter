...
mixin _$PollsQuery {
 ...
 PollsFilter? get filter; List<PollsSort>? get sort; int? get limit; String? get next; String? get previous;
...
abstract mixin class $PollsQueryCopyWith<$Res>  {
  factory $PollsQueryCopyWith(PollsQuery value, $Res Function(PollsQuery) _then) = _$PollsQueryCopyWithImpl;
@useResult
$Res call({
 Filter<PollData>? filter, List<PollsSort>? sort, int? limit, String? next, String? previous
});
...
/// @nodoc
class _$PollsQueryCopyWithImpl<$Res>
    implements $PollsQueryCopyWith<$Res> {
...
as Filter<PollData>?,sort: freezed == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
as List<PollsSort>?,limit: freezed == limit ? _self.limit : limit // ignore: cast_nullable_to_non_nullable
