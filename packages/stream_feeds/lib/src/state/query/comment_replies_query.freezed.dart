...
mixin _$CommentRepliesQuery {
 ...
 String get commentId; CommentsSort? get sort; int? get depth; int? get limit; int? get repliesLimit; String? get next; String? get previous;
/// Create a copy of CommentRepliesQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CommentRepliesQueryCopyWith<CommentRepliesQuery> get copyWith => _$CommentRepliesQueryCopyWithImpl<CommentRepliesQuery>(this as CommentRepliesQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentRepliesQuery&&(identical(other.commentId, commentId) || other.commentId == commentId)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.depth, depth) || other.depth == depth)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.repliesLimit, repliesLimit) || other.repliesLimit == repliesLimit)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous));
}


@override
int get hashCode => Object.hash(runtimeType,commentId,sort,depth,limit,repliesLimit,next,previous);
...
abstract mixin class $CommentRepliesQueryCopyWith<$Res>  {
  factory $CommentRepliesQueryCopyWith(CommentRepliesQuery value, $Res Function(CommentRepliesQuery) _then) = _$CommentRepliesQueryCopyWithImpl;
@useResult
$Res call({
 String commentId, CommentsSort? sort, int? depth, int? limit, int? repliesLimit, String? next, String? previous
});
...
/// Create a copy of CommentRepliesQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? commentId = null,Object? sort = freezed,Object? depth = freezed,Object? limit = freezed,Object? repliesLimit = freezed,Object? next = freezed,Object? previous = freezed,}) {
