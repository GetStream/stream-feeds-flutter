...
mixin _$BookmarksQuery {
 ...
 BookmarksFilter? get filter; List<BookmarksSort>? get sort; int? get limit; String? get next; String? get previous;
/// Create a copy of BookmarksQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BookmarksQueryCopyWith<BookmarksQuery> get copyWith => _$BookmarksQueryCopyWithImpl<BookmarksQuery>(this as BookmarksQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookmarksQuery&&(identical(other.filter, filter) || other.filter == filter)&&const DeepCollectionEquality().equals(other.sort, sort)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous));
}
...
abstract mixin class $BookmarksQueryCopyWith<$Res>  {
  factory $BookmarksQueryCopyWith(BookmarksQuery value, $Res Function(BookmarksQuery) _then) = _$BookmarksQueryCopyWithImpl;
@useResult
$Res call({
 Filter<BookmarkData>? filter, List<BookmarksSort>? sort, int? limit, String? next, String? previous
});
...
as Filter<BookmarkData>?,sort: freezed == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
as List<BookmarksSort>?,limit: freezed == limit ? _self.limit : limit // ignore: cast_nullable_to_non_nullable
