...
mixin _$BookmarkFoldersQuery {
 ...
 BookmarkFoldersFilter? get filter; List<BookmarkFoldersSort>? get sort; int? get limit; String? get next; String? get previous;
/// Create a copy of BookmarkFoldersQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BookmarkFoldersQueryCopyWith<BookmarkFoldersQuery> get copyWith => _$BookmarkFoldersQueryCopyWithImpl<BookmarkFoldersQuery>(this as BookmarkFoldersQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookmarkFoldersQuery&&(identical(other.filter, filter) || other.filter == filter)&&const DeepCollectionEquality().equals(other.sort, sort)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous));
}
...
abstract mixin class $BookmarkFoldersQueryCopyWith<$Res>  {
  factory $BookmarkFoldersQueryCopyWith(BookmarkFoldersQuery value, $Res Function(BookmarkFoldersQuery) _then) = _$BookmarkFoldersQueryCopyWithImpl;
@useResult
$Res call({
 Filter<BookmarkFolderData>? filter, List<BookmarkFoldersSort>? sort, int? limit, String? next, String? previous
});
...
as Filter<BookmarkFolderData>?,sort: freezed == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
as List<BookmarkFoldersSort>?,limit: freezed == limit ? _self.limit : limit // ignore: cast_nullable_to_non_nullable
