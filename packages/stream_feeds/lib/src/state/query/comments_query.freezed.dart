...
mixin _$CommentsQuery {
 ...
 CommentsFilter? get filter; CommentsSort? get sort; int? get limit; String? get next; String? get previous;
/// Create a copy of CommentsQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CommentsQueryCopyWith<CommentsQuery> get copyWith => _$CommentsQueryCopyWithImpl<CommentsQuery>(this as CommentsQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentsQuery&&(identical(other.filter, filter) || other.filter == filter)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous));
}
...
abstract mixin class $CommentsQueryCopyWith<$Res>  {
  factory $CommentsQueryCopyWith(CommentsQuery value, $Res Function(CommentsQuery) _then) = _$CommentsQueryCopyWithImpl;
@useResult
$Res call({
 Filter<CommentData>? filter, CommentsSort? sort, int? limit, String? next, String? previous
});
...
as Filter<CommentData>?,sort: freezed == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
