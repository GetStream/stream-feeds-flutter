...
mixin _$FollowsQuery {
 ...
 FollowsFilter? get filter; List<FollowsSort>? get sort; int? get limit; String? get next; String? get previous;
/// Create a copy of FollowsQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FollowsQueryCopyWith<FollowsQuery> get copyWith => _$FollowsQueryCopyWithImpl<FollowsQuery>(this as FollowsQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FollowsQuery&&(identical(other.filter, filter) || other.filter == filter)&&const DeepCollectionEquality().equals(other.sort, sort)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous));
}
...
abstract mixin class $FollowsQueryCopyWith<$Res>  {
  factory $FollowsQueryCopyWith(FollowsQuery value, $Res Function(FollowsQuery) _then) = _$FollowsQueryCopyWithImpl;
@useResult
$Res call({
 Filter<FollowData>? filter, List<FollowsSort>? sort, int? limit, String? next, String? previous
});
...
/// @nodoc
class _$FollowsQueryCopyWithImpl<$Res>
    implements $FollowsQueryCopyWith<$Res> {
...
as Filter<FollowData>?,sort: freezed == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
as List<FollowsSort>?,limit: freezed == limit ? _self.limit : limit // ignore: cast_nullable_to_non_nullable
