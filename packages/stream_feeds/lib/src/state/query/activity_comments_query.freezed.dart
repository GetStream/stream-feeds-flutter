...
mixin _$ActivityCommentsQuery {
 ...
 String get objectId; String get objectType; CommentsSort? get sort; int? get depth; int? get limit; int? get repliesLimit; String? get next; String? get previous;
/// Create a copy of ActivityCommentsQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ActivityCommentsQueryCopyWith<ActivityCommentsQuery> get copyWith => _$ActivityCommentsQueryCopyWithImpl<ActivityCommentsQuery>(this as ActivityCommentsQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ActivityCommentsQuery&&(identical(other.objectId, objectId) || other.objectId == objectId)&&(identical(other.objectType, objectType) || other.objectType == objectType)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.depth, depth) || other.depth == depth)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.repliesLimit, repliesLimit) || other.repliesLimit == repliesLimit)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous));
}


@override
int get hashCode => Object.hash(runtimeType,objectId,objectType,sort,depth,limit,repliesLimit,next,previous);
...
abstract mixin class $ActivityCommentsQueryCopyWith<$Res>  {
  factory $ActivityCommentsQueryCopyWith(ActivityCommentsQuery value, $Res Function(ActivityCommentsQuery) _then) = _$ActivityCommentsQueryCopyWithImpl;
@useResult
$Res call({
 String objectId, String objectType, CommentsSort? sort, int? depth, int? limit, int? repliesLimit, String? next, String? previous
});
...
/// Create a copy of ActivityCommentsQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? objectId = null,Object? objectType = null,Object? sort = freezed,Object? depth = freezed,Object? limit = freezed,Object? repliesLimit = freezed,Object? next = freezed,Object? previous = freezed,}) {
