...
abstract mixin class $CommentReplyListStateCopyWith<$Res> {
  factory $CommentReplyListStateCopyWith(
    CommentReplyListState value,
    $Res Function(CommentReplyListState) _then,
  ) = _$CommentReplyListStateCopyWithImpl;
  @useResult
  $Res call({List<CommentData> replies, PaginationData? pagination});
}

/// @nodoc
class _$CommentReplyListStateCopyWithImpl<$Res> implements $CommentReplyListStateCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? replies = null, Object? pagination = freezed}) {
    return _then(
