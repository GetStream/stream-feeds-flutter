...
class FollowData with _$FollowData {
  /// Creates a new instance of [FollowData].
...
/// Extension function to convert a [api.FollowResponse] to a [FollowData] model.
extension FollowResponseMapper on api.FollowResponse {
...
/// Extension function to convert a [api.FollowResponseStatus] to a [FollowStatus] model.
extension FollowResponseStatusMapper on api.FollowResponseStatus {
  ...
  FollowStatus toModel() {
    return switch (this) {
      api.FollowResponseStatus.accepted => FollowStatus.accepted,
      api.FollowResponseStatus.pending => FollowStatus.pending,
      api.FollowResponseStatus.rejected => FollowStatus.rejected,
      api.FollowResponseStatus.unknown => FollowStatus.unknown,
    };
  }
}
