...
class PollVoteData with _$PollVoteData {
  /// Creates a new instance of [PollVoteData].
  const PollVoteData({
...
/// Extension function to convert a [api.PollVoteResponseData] to a [PollVoteData] model.
extension PollVoteResponseMapper on api.PollVoteResponseData {
