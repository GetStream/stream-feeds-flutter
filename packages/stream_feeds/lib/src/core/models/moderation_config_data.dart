...
class ModerationConfigData with _$ModerationConfigData {
  ...
  @override
  final api.AIImageConfig? aiImageConfig;

  /// Configuration for AI-based text moderation analysis.
  @override
  final api.AITextConfig? aiTextConfig;

  /// Configuration for AI-based video moderation analysis.
  @override
  final api.AIVideoConfig? aiVideoConfig;
  ...
  @override
  final api.AutomodPlatformCircumventionConfig?
      automodPlatformCircumventionConfig;

  /// Configuration for semantic filters that detect harmful content patterns.
  @override
  final api.AutomodSemanticFiltersConfig? automodSemanticFiltersConfig;

  /// Configuration for toxicity detection in user-generated content.
  @override
  final api.AutomodToxicityConfig? automodToxicityConfig;

  /// Configuration for custom block lists to filter prohibited content.
  @override
  final api.BlockListConfig? blockListConfig;
  ...
  @override
  final api.VelocityFilterConfig? velocityFilterConfig;
...
/// Extension function to convert a [api.ConfigResponse] to a [ModerationConfigData] model.
extension ModerationConfigDataMapper on api.ConfigResponse {
