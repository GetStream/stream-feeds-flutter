...
class Moderation with _$Moderation {
  /// Creates a new instance of [Moderation].
  const Moderation({
...
/// Extension function to convert a [api.ModerationV2Response] to a [Moderation] model.
extension ModerationResponseMapper on api.ModerationV2Response {
