...
$BypassActionRequestCopyWith<BypassActionRequest> get copyWith => _$BypassActionRequestCopyWithImpl<BypassActionRequest>(this as BypassActionRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BypassActionRequest&&(identical(other.enabled, enabled) || other.enabled == enabled));
}
...
abstract mixin class $BypassActionRequestCopyWith<$Res>  {
  factory $BypassActionRequestCopyWith(BypassActionRequest value, $Res Function(BypassActionRequest) _then) = _$BypassActionRequestCopyWithImpl;
@useResult
$Res call({
 bool? enabled
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? enabled = freezed,}) {
  return _then(BypassActionRequest(
