...
CommentRestoredEvent _$CommentRestoredEventFromJson(Map<String, dynamic> json) => CommentRestoredEvent(
...
Map<String, dynamic> _$CommentRestoredEventToJson(CommentRestoredEvent instance) => <String, dynamic>{
