...
FollowUpdatedEvent _$FollowUpdatedEventFromJson(Map<String, dynamic> json) => FollowUpdatedEvent(
...
Map<String, dynamic> _$FollowUpdatedEventToJson(FollowUpdatedEvent instance) => <String, dynamic>{
