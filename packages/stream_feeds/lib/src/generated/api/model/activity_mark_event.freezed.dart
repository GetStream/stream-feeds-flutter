...
mixin _$ActivityMarkEvent {
 ...
 DateTime get createdAt; Map<String, Object?> get custom; String? get feedVisibility; String get fid; bool? get markAllRead; bool? get markAllSeen; List<String>? get markRead; List<String>? get markSeen; List<String>? get markWatched; DateTime? get receivedAt; String get type; UserResponseCommonFields? get user;
/// Create a copy of ActivityMarkEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ActivityMarkEventCopyWith<ActivityMarkEvent> get copyWith => _$ActivityMarkEventCopyWithImpl<ActivityMarkEvent>(this as ActivityMarkEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ActivityMarkEvent&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.feedVisibility, feedVisibility) || other.feedVisibility == feedVisibility)&&(identical(other.fid, fid) || other.fid == fid)&&(identical(other.markAllRead, markAllRead) || other.markAllRead == markAllRead)&&(identical(other.markAllSeen, markAllSeen) || other.markAllSeen == markAllSeen)&&const DeepCollectionEquality().equals(other.markRead, markRead)&&const DeepCollectionEquality().equals(other.markSeen, markSeen)&&const DeepCollectionEquality().equals(other.markWatched, markWatched)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}


@override
int get hashCode => Object.hash(runtimeType,createdAt,const DeepCollectionEquality().hash(custom),feedVisibility,fid,markAllRead,markAllSeen,const DeepCollectionEquality().hash(markRead),const DeepCollectionEquality().hash(markSeen),const DeepCollectionEquality().hash(markWatched),receivedAt,type,user);
...
abstract mixin class $ActivityMarkEventCopyWith<$Res>  {
  factory $ActivityMarkEventCopyWith(ActivityMarkEvent value, $Res Function(ActivityMarkEvent) _then) = _$ActivityMarkEventCopyWithImpl;
@useResult
$Res call({
 DateTime createdAt, Map<String, Object?> custom, String? feedVisibility, String fid, bool? markAllRead, bool? markAllSeen, List<String>? markRead, List<String>? markSeen, List<String>? markWatched, DateTime? receivedAt, String type, UserResponseCommonFields? user
});
...
as List<String>?,markSeen: freezed == markSeen ? _self.markSeen : markSeen // ignore: cast_nullable_to_non_nullable
as List<String>?,markWatched: freezed == markWatched ? _self.markWatched : markWatched // ignore: cast_nullable_to_non_nullable
as List<String>?,receivedAt: freezed == receivedAt ? _self.receivedAt : receivedAt // ignore: cast_nullable_to_non_nullable
