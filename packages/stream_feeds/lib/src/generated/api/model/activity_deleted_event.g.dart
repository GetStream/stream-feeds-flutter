...
ActivityDeletedEvent _$ActivityDeletedEventFromJson(Map<String, dynamic> json) => ActivityDeletedEvent(
...
Map<String, dynamic> _$ActivityDeletedEventToJson(ActivityDeletedEvent instance) => <String, dynamic>{
