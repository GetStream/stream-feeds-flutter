...
class QueryBookmarkFoldersRequest {
  ...
  static QueryBookmarkFoldersRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<QueryBookmarkFoldersRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <QueryBookmarkFoldersRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QueryBookmarkFoldersRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
