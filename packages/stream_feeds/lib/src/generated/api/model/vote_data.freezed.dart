...
mixin _$VoteData {
 ...
 String? get answerText; String? get optionId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VoteData&&(identical(other.answerText, answerText) || other.answerText == answerText)&&(identical(other.optionId, optionId) || other.optionId == optionId));
}
...
@useResult
$Res call({
 String? answerText, String? optionId
});
...
/// Create a copy of VoteData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? answerText = freezed,Object? optionId = freezed,}) {
