...
class LimitsSettings {
  ...
  static LimitsSettings? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<LimitsSettings> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <LimitsSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LimitsSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is LimitsSettings &&
