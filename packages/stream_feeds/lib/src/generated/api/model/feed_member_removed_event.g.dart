...
FeedMemberRemovedEvent _$FeedMemberRemovedEventFromJson(Map<String, dynamic> json) => FeedMemberRemovedEvent(
...
Map<String, dynamic> _$FeedMemberRemovedEventToJson(FeedMemberRemovedEvent instance) => <String, dynamic>{
