...
$UpdateBookmarkResponseCopyWith<UpdateBookmarkResponse> get copyWith => _$UpdateBookmarkResponseCopyWithImpl<UpdateBookmarkResponse>(this as UpdateBookmarkResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateBookmarkResponse&&(identical(other.bookmark, bookmark) || other.bookmark == bookmark)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $UpdateBookmarkResponseCopyWith<$Res>  {
  factory $UpdateBookmarkResponseCopyWith(UpdateBookmarkResponse value, $Res Function(UpdateBookmarkResponse) _then) = _$UpdateBookmarkResponseCopyWithImpl;
@useResult
$Res call({
