...
ChatMessageResponse _$ChatMessageResponseFromJson(Map<String, dynamic> json) => ChatMessageResponse(
  ...
  draft: json['draft'] == null ? null : ChatDraftResponse.fromJson(json['draft'] as Map<String, dynamic>),
  ...
  moderation: json['moderation'] == null
      ? null
      : ChatModerationV2Response.fromJson(json['moderation'] as Map<String, dynamic>),
  ...
  reactionGroups: (json['reaction_groups'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(k, ChatReactionGroupResponse.fromJson(e as Map<String, dynamic>)),
  ),
  reactionScores: Map<String, int>.from(json['reaction_scores'] as Map),
  reminder: json['reminder'] == null
      ? null
      : ChatReminderResponseData.fromJson(json['reminder'] as Map<String, dynamic>),
  ...
  sharedLocation: json['shared_location'] == null
      ? null
      : ChatSharedLocationResponseData.fromJson(json['shared_location'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ChatMessageResponseToJson(ChatMessageResponse instance) => <String, dynamic>{
