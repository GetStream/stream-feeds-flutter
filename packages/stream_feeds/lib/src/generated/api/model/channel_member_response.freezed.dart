...
abstract mixin class $ChannelMemberResponseCopyWith<$Res>  {
  factory $ChannelMemberResponseCopyWith(ChannelMemberResponse value, $Res Function(ChannelMemberResponse) _then) = _$ChannelMemberResponseCopyWithImpl;
@useResult
$Res call({
 DateTime? archivedAt, DateTime? banExpires, bool banned, String channelRole, DateTime createdAt, Map<String, Object?> custom, DateTime? deletedAt, List<String>? deletedMessages, DateTime? inviteAcceptedAt, DateTime? inviteRejectedAt, bool? invited, bool? isModerator, bool notificationsMuted, DateTime? pinnedAt, String? role, bool shadowBanned, String? status, DateTime updatedAt, UserResponse? user, String? userId
});
...
/// Create a copy of ChannelMemberResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? archivedAt = freezed,Object? banExpires = freezed,Object? banned = null,Object? channelRole = null,Object? createdAt = null,Object? custom = null,Object? deletedAt = freezed,Object? deletedMessages = freezed,Object? inviteAcceptedAt = freezed,Object? inviteRejectedAt = freezed,Object? invited = freezed,Object? isModerator = freezed,Object? notificationsMuted = null,Object? pinnedAt = freezed,Object? role = freezed,Object? shadowBanned = null,Object? status = freezed,Object? updatedAt = null,Object? user = freezed,Object? userId = freezed,}) {
  return _then(ChannelMemberResponse(
archivedAt: freezed == archivedAt ? _self.archivedAt : archivedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,banExpires: freezed == banExpires ? _self.banExpires : banExpires // ignore: cast_nullable_to_non_nullable
...
as List<String>?,inviteAcceptedAt: freezed == inviteAcceptedAt ? _self.inviteAcceptedAt : inviteAcceptedAt // ignore: cast_nullable_to_non_nullable
