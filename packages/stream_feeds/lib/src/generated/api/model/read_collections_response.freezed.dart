...
$ReadCollectionsResponseCopyWith<ReadCollectionsResponse> get copyWith => _$ReadCollectionsResponseCopyWithImpl<ReadCollectionsResponse>(this as ReadCollectionsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReadCollectionsResponse&&const DeepCollectionEquality().equals(other.collections, collections)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $ReadCollectionsResponseCopyWith<$Res>  {
  factory $ReadCollectionsResponseCopyWith(ReadCollectionsResponse value, $Res Function(ReadCollectionsResponse) _then) = _$ReadCollectionsResponseCopyWithImpl;
@useResult
$Res call({
