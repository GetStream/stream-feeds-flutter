...
part 'shadow_block_action_request_payload.g.dart';
part 'shadow_block_action_request_payload.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class ShadowBlockActionRequestPayload with _$ShadowBlockActionRequestPayload {
  const ShadowBlockActionRequestPayload({
    this.reason,
  });
