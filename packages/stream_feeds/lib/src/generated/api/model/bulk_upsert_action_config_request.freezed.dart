...
mixin _$BulkUpsertActionConfigRequest {
  ...
  $BulkUpsertActionConfigRequestCopyWith<BulkUpsertActionConfigRequest>
      get copyWith => _$BulkUpsertActionConfigRequestCopyWithImpl<
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.actionConfigs, actionConfigs));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(actionConfigs));
