...
mixin _$SharedLocationResponse {
 ...
 ChannelResponse? get channel; String get channelCid; DateTime get createdAt; String get createdByDeviceId; String get duration; DateTime? get endAt; double get latitude; double get longitude; MessageResponse? get message; String get messageId; DateTime get updatedAt; String get userId;
/// Create a copy of SharedLocationResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SharedLocationResponseCopyWith<SharedLocationResponse> get copyWith => _$SharedLocationResponseCopyWithImpl<SharedLocationResponse>(this as SharedLocationResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SharedLocationResponse&&(identical(other.channel, channel) || other.channel == channel)&&(identical(other.channelCid, channelCid) || other.channelCid == channelCid)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdByDeviceId, createdByDeviceId) || other.createdByDeviceId == createdByDeviceId)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.endAt, endAt) || other.endAt == endAt)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.message, message) || other.message == message)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.userId, userId) || other.userId == userId));
}


@override
int get hashCode => Object.hash(runtimeType,channel,channelCid,createdAt,createdByDeviceId,duration,endAt,latitude,longitude,message,messageId,updatedAt,userId);
...
abstract mixin class $SharedLocationResponseCopyWith<$Res>  {
  factory $SharedLocationResponseCopyWith(SharedLocationResponse value, $Res Function(SharedLocationResponse) _then) = _$SharedLocationResponseCopyWithImpl;
@useResult
$Res call({
 ChannelResponse? channel, String channelCid, DateTime createdAt, String createdByDeviceId, String duration, DateTime? endAt, double latitude, double longitude, MessageResponse? message, String messageId, DateTime updatedAt, String userId
});
...
/// Create a copy of SharedLocationResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? channel = freezed,Object? channelCid = null,Object? createdAt = null,Object? createdByDeviceId = null,Object? duration = null,Object? endAt = freezed,Object? latitude = null,Object? longitude = null,Object? message = freezed,Object? messageId = null,Object? updatedAt = null,Object? userId = null,}) {
