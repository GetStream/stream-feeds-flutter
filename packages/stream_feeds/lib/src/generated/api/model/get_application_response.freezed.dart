...
mixin _$GetApplicationResponse {
 ...
 AppResponseFields get app; String get duration;
/// Create a copy of GetApplicationResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GetApplicationResponseCopyWith<GetApplicationResponse> get copyWith => _$GetApplicationResponseCopyWithImpl<GetApplicationResponse>(this as GetApplicationResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetApplicationResponse&&(identical(other.app, app) || other.app == app)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $GetApplicationResponseCopyWith<$Res>  {
  factory $GetApplicationResponseCopyWith(GetApplicationResponse value, $Res Function(GetApplicationResponse) _then) = _$GetApplicationResponseCopyWithImpl;
@useResult
$Res call({
 AppResponseFields app, String duration
});
...
/// Create a copy of GetApplicationResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? app = null,Object? duration = null,}) {
