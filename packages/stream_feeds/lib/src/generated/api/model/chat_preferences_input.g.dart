...
Map<String, dynamic> _$ChatPreferencesInputToJson(ChatPreferencesInput instance) => <String, dynamic>{
  ...
  'group_mentions': _$ChatPreferencesInputGroupMentionsEnumMap[instance.groupMentions],
  'here_mentions': _$ChatPreferencesInputHereMentionsEnumMap[instance.hereMentions],
  'role_mentions': _$ChatPreferencesInputRoleMentionsEnumMap[instance.roleMentions],
  'thread_replies': _$ChatPreferencesInputThreadRepliesEnumMap[instance.threadReplies],
};
