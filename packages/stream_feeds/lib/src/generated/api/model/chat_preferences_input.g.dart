...
Map<String, dynamic> _$ChatPreferencesInputToJson(
    ...
    <String, dynamic>{
      'channel_mentions': _$ChatPreferencesInputChannelMentionsEnumMap[
          instance.channelMentions],
      'default_preference': _$ChatPreferencesInputDefaultPreferenceEnumMap[
          instance.defaultPreference],
      'direct_mentions':
