...
mixin _$UserMuteResponse {
 ...
 DateTime get createdAt; DateTime? get expires; UserResponse? get target; DateTime get updatedAt; UserResponse? get user;
/// Create a copy of UserMuteResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UserMuteResponseCopyWith<UserMuteResponse> get copyWith => _$UserMuteResponseCopyWithImpl<UserMuteResponse>(this as UserMuteResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserMuteResponse&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.expires, expires) || other.expires == expires)&&(identical(other.target, target) || other.target == target)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.user, user) || other.user == user));
}
...
abstract mixin class $UserMuteResponseCopyWith<$Res>  {
  factory $UserMuteResponseCopyWith(UserMuteResponse value, $Res Function(UserMuteResponse) _then) = _$UserMuteResponseCopyWithImpl;
@useResult
$Res call({
 DateTime createdAt, DateTime? expires, UserResponse? target, DateTime updatedAt, UserResponse? user
});
...
/// Create a copy of UserMuteResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? expires = freezed,Object? target = freezed,Object? updatedAt = null,Object? user = freezed,}) {
