...
mixin _$Command {
 ...
 String get args; DateTime? get createdAt; String get description; String get name; String get set; DateTime? get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,args,createdAt,description,name,set,updatedAt);
...
@useResult
$Res call({
 String args, DateTime? createdAt, String description, String name, String set, DateTime? updatedAt
});
...
/// Create a copy of Command
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? args = null,Object? createdAt = freezed,Object? description = null,Object? name = null,Object? set = null,Object? updatedAt = freezed,}) {
...
as String,set: null == set ? _self.set : set // ignore: cast_nullable_to_non_nullable
