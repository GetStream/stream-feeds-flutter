...
part 'appeal_response.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class AppealResponse with _$AppealResponse {
  ...
  static AppealResponse fromJson(Map<String, dynamic> json) => _$AppealResponseFromJson(json);
}
