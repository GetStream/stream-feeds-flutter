...
$QueryCommentReactionsResponseCopyWith<QueryCommentReactionsResponse> get copyWith => _$QueryCommentReactionsResponseCopyWithImpl<QueryCommentReactionsResponse>(this as QueryCommentReactionsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryCommentReactionsResponse&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.reactions, reactions));
}
...
abstract mixin class $QueryCommentReactionsResponseCopyWith<$Res>  {
  factory $QueryCommentReactionsResponseCopyWith(QueryCommentReactionsResponse value, $Res Function(QueryCommentReactionsResponse) _then) = _$QueryCommentReactionsResponseCopyWithImpl;
@useResult
$Res call({
