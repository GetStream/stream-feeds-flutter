...
mixin _$GetOrCreateUnfollowRequest {
  ...
  $GetOrCreateUnfollowRequestCopyWith<GetOrCreateUnfollowRequest> get copyWith =>
      _$GetOrCreateUnfollowRequestCopyWithImpl<GetOrCreateUnfollowRequest>(
        this as GetOrCreateUnfollowRequest,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GetOrCreateUnfollowRequest &&
            (identical(
            ...
            (identical(other.keepHistory, keepHistory) || other.keepHistory == keepHistory) &&
...
abstract mixin class $GetOrCreateUnfollowRequestCopyWith<$Res> {
  factory $GetOrCreateUnfollowRequestCopyWith(
    GetOrCreateUnfollowRequest value,
    $Res Function(GetOrCreateUnfollowRequest) _then,
  ) = _$GetOrCreateUnfollowRequestCopyWithImpl;
  @useResult
  $Res call({
...
/// @nodoc
class _$GetOrCreateUnfollowRequestCopyWithImpl<$Res> implements $GetOrCreateUnfollowRequestCopyWith<$Res> {
