...
KeyframeRuleParameters _$KeyframeRuleParametersFromJson(Map<String, dynamic> json) => KeyframeRuleParameters(
...
Map<String, dynamic> _$KeyframeRuleParametersToJson(KeyframeRuleParameters instance) => <String, dynamic>{
