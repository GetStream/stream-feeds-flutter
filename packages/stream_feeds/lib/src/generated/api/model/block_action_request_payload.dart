...
part 'block_action_request_payload.g.dart';
part 'block_action_request_payload.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class BlockActionRequestPayload with _$BlockActionRequestPayload {
  const BlockActionRequestPayload({
    this.reason,
  });
