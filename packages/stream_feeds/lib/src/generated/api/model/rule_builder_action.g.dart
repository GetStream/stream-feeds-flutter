...
RuleBuilderAction _$RuleBuilderActionFromJson(Map<String, dynamic> json) => RuleBuilderAction(
  banOptions: json['ban_options'] == null ? null : BanOptions.fromJson(json['ban_options'] as Map<String, dynamic>),
  callOptions: json['call_options'] == null
      ? null
      : CallActionOptions.fromJson(json['call_options'] as Map<String, dynamic>),
  flagUserOptions: json['flag_user_options'] == null
      ? null
      : FlagUserOptions.fromJson(json['flag_user_options'] as Map<String, dynamic>),
  skipInbox: json['skip_inbox'] as bool?,
  type: $enumDecodeNullable(_$RuleBuilderActionTypeEnumMap, json['type'], unknownValue: RuleBuilderActionType.unknown),
);

Map<String, dynamic> _$RuleBuilderActionToJson(RuleBuilderAction instance) => <String, dynamic>{
