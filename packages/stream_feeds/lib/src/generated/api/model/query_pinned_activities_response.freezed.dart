...
mixin _$QueryPinnedActivitiesResponse {
  ...
  $QueryPinnedActivitiesResponseCopyWith<QueryPinnedActivitiesResponse>
      get copyWith => _$QueryPinnedActivitiesResponseCopyWithImpl<
              QueryPinnedActivitiesResponse>(
          this as QueryPinnedActivitiesResponse, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, duration, next,
      const DeepCollectionEquality().hash(pinnedActivities), prev);
