...
PollDeletedFeedEvent _$PollDeletedFeedEventFromJson(Map<String, dynamic> json) => PollDeletedFeedEvent(
...
Map<String, dynamic> _$PollDeletedFeedEventToJson(PollDeletedFeedEvent instance) => <String, dynamic>{
