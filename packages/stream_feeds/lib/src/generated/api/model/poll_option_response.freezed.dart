...
mixin _$PollOptionResponse {
 ...
 String get duration; PollOptionResponseData get pollOption;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PollOptionResponse&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.pollOption, pollOption) || other.pollOption == pollOption));
}
...
@useResult
$Res call({
 String duration, PollOptionResponseData pollOption
});
...
/// Create a copy of PollOptionResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? duration = null,Object? pollOption = null,}) {
  return _then(PollOptionResponse(
duration: null == duration ? _self.duration : duration // ignore: cast_nullable_to_non_nullable
as String,pollOption: null == pollOption ? _self.pollOption : pollOption // ignore: cast_nullable_to_non_nullable
