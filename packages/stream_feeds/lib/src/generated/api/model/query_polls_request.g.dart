...
class QueryPollsRequest {
  ...
  static QueryPollsRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<QueryPollsRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <QueryPollsRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QueryPollsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
