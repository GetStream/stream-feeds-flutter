...
mixin _$FeedResponse {
 ...
 int get activityCount; DateTime get createdAt; UserResponse get createdBy; Map<String, Object?>? get custom; DateTime? get deletedAt; String get description; String get feed; List<String>? get filterTags; int get followerCount; int get followingCount; String get groupId; String get id; Location? get location; int get memberCount; String get name; List<FeedResponseOwnCapabilities>? get ownCapabilities; List<FollowResponse>? get ownFollowings; List<FollowResponse>? get ownFollows; FeedMemberResponse? get ownMembership; int get pinCount; DateTime get updatedAt; FeedResponseVisibility? get visibility;
...
@useResult
$Res call({
 int activityCount, DateTime createdAt, UserResponse createdBy, Map<String, Object?>? custom, DateTime? deletedAt, String description, String feed, List<String>? filterTags, int followerCount, int followingCount, String groupId, String id, Location? location, int memberCount, String name, List<FeedResponseOwnCapabilities>? ownCapabilities, List<FollowResponse>? ownFollowings, List<FollowResponse>? ownFollows, FeedMemberResponse? ownMembership, int pinCount, DateTime updatedAt, FeedResponseVisibility? visibility
});
...
as List<FeedResponseOwnCapabilities>?,ownFollowings: freezed == ownFollowings ? _self.ownFollowings : ownFollowings // ignore: cast_nullable_to_non_nullable
