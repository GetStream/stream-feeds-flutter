...
/// @nodoc
abstract mixin class $GetOGResponseCopyWith<$Res>  {
  factory $GetOGResponseCopyWith(GetOGResponse value, $Res Function(GetOGResponse) _then) = _$GetOGResponseCopyWithImpl;
@useResult
$Res call({
 List<Action>? actions, String? assetUrl, String? authorIcon, String? authorLink, String? authorName, String? color, Map<String, Object?> custom, String duration, String? fallback, List<Field>? fields, String? footer, String? footerIcon, Images? giphy, String? imageUrl, String? ogScrapeUrl, int? originalHeight, int? originalWidth, String? pretext, String? text, String? thumbUrl, String? title, String? titleLink, String? type
});
...
class _$GetOGResponseCopyWithImpl<$Res>
  ...
  final $Res Function(GetOGResponse) _then;

/// Create a copy of GetOGResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? actions = freezed,Object? assetUrl = freezed,Object? authorIcon = freezed,Object? authorLink = freezed,Object? authorName = freezed,Object? color = freezed,Object? custom = null,Object? duration = null,Object? fallback = freezed,Object? fields = freezed,Object? footer = freezed,Object? footerIcon = freezed,Object? giphy = freezed,Object? imageUrl = freezed,Object? ogScrapeUrl = freezed,Object? originalHeight = freezed,Object? originalWidth = freezed,Object? pretext = freezed,Object? text = freezed,Object? thumbUrl = freezed,Object? title = freezed,Object? titleLink = freezed,Object? type = freezed,}) {
  return _then(GetOGResponse(
actions: freezed == actions ? _self.actions : actions // ignore: cast_nullable_to_non_nullable
as List<Action>?,assetUrl: freezed == assetUrl ? _self.assetUrl : assetUrl // ignore: cast_nullable_to_non_nullable
as String?,authorIcon: freezed == authorIcon ? _self.authorIcon : authorIcon // ignore: cast_nullable_to_non_nullable
...
as Map<String, Object?>,duration: null == duration ? _self.duration : duration // ignore: cast_nullable_to_non_nullable
...
as List<Field>?,footer: freezed == footer ? _self.footer : footer // ignore: cast_nullable_to_non_nullable
...
as String?,ogScrapeUrl: freezed == ogScrapeUrl ? _self.ogScrapeUrl : ogScrapeUrl // ignore: cast_nullable_to_non_nullable
as String?,originalHeight: freezed == originalHeight ? _self.originalHeight : originalHeight // ignore: cast_nullable_to_non_nullable
...
as String?,titleLink: freezed == titleLink ? _self.titleLink : titleLink // ignore: cast_nullable_to_non_nullable
