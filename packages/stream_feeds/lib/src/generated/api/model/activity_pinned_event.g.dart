...
class ActivityPinnedEvent {
  ...
  static ActivityPinnedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ActivityPinnedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.activity.pinned")!,
  ...
  static List<ActivityPinnedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityPinnedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityPinnedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
