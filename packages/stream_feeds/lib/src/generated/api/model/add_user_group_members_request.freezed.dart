...
mixin _$AddUserGroupMembersRequest {
  ...
  $AddUserGroupMembersRequestCopyWith<AddUserGroupMembersRequest>
      get copyWith =>
          _$AddUserGroupMembersRequestCopyWithImpl<AddUserGroupMembersRequest>(
              this as AddUserGroupMembersRequest, _$identity);
  ...
  @override
  int get hashCode => Object.hash(runtimeType, asAdmin,
      const DeepCollectionEquality().hash(memberIds), teamId);
...
abstract mixin class $AddUserGroupMembersRequestCopyWith<$Res> {
  factory $AddUserGroupMembersRequestCopyWith(AddUserGroupMembersRequest value,
