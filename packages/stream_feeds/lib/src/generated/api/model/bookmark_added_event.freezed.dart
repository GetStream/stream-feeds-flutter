...
/// Create a copy of BookmarkAddedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BookmarkAddedEventCopyWith<BookmarkAddedEvent> get copyWith => _$BookmarkAddedEventCopyWithImpl<BookmarkAddedEvent>(this as BookmarkAddedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookmarkAddedEvent&&(identical(other.bookmark, bookmark) || other.bookmark == bookmark)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}
...
@override
String toString() {
  return 'BookmarkAddedEvent(bookmark: $bookmark, createdAt: $createdAt, custom: $custom, receivedAt: $receivedAt, type: $type, user: $user)';
}
...
/// @nodoc
abstract mixin class $BookmarkAddedEventCopyWith<$Res>  {
  factory $BookmarkAddedEventCopyWith(BookmarkAddedEvent value, $Res Function(BookmarkAddedEvent) _then) = _$BookmarkAddedEventCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$BookmarkAddedEventCopyWithImpl<$Res>
    implements $BookmarkAddedEventCopyWith<$Res> {
  _$BookmarkAddedEventCopyWithImpl(this._self, this._then);

  final BookmarkAddedEvent _self;
  final $Res Function(BookmarkAddedEvent) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? bookmark = null,Object? createdAt = null,Object? custom = null,Object? receivedAt = freezed,Object? type = null,Object? user = freezed,}) {
  return _then(BookmarkAddedEvent(
