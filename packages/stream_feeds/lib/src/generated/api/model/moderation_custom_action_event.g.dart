...
ModerationCustomActionEvent _$ModerationCustomActionEventFromJson(Map<String, dynamic> json) =>
    ModerationCustomActionEvent(
      ...
      reviewQueueItem: ReviewQueueItemResponse.fromJson(json['review_queue_item'] as Map<String, dynamic>),
      type: json['type'] as String,
    );

Map<String, dynamic> _$ModerationCustomActionEventToJson(ModerationCustomActionEvent instance) => <String, dynamic>{
