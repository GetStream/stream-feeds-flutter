...
$RestoreActivityResponseCopyWith<RestoreActivityResponse> get copyWith => _$RestoreActivityResponseCopyWithImpl<RestoreActivityResponse>(this as RestoreActivityResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RestoreActivityResponse&&(identical(other.activity, activity) || other.activity == activity)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $RestoreActivityResponseCopyWith<$Res>  {
  factory $RestoreActivityResponseCopyWith(RestoreActivityResponse value, $Res Function(RestoreActivityResponse) _then) = _$RestoreActivityResponseCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RestoreActivityResponseCopyWithImpl<$Res>
    implements $RestoreActivityResponseCopyWith<$Res> {
...
@pragma('vm:prefer-inline') @override $Res call({Object? activity = null,Object? duration = null,}) {
  return _then(RestoreActivityResponse(
