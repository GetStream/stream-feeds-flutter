...
abstract mixin class $UpdatePollRequestCopyWith<$Res>  {
  factory $UpdatePollRequestCopyWith(UpdatePollRequest value, $Res Function(UpdatePollRequest) _then) = _$UpdatePollRequestCopyWithImpl;
@useResult
$Res call({
 bool? allowAnswers, bool? allowUserSuggestedOptions, Map<String, Object?>? custom, String? description, bool? enforceUniqueVote, String id, bool? isClosed, int? maxVotesAllowed, String name, List<PollOptionRequest>? options, UpdatePollRequestVotingVisibility? votingVisibility
});
...
as List<PollOptionRequest>?,votingVisibility: freezed == votingVisibility ? _self.votingVisibility : votingVisibility // ignore: cast_nullable_to_non_nullable
