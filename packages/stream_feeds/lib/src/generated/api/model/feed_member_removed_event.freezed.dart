...
mixin _$FeedMemberRemovedEvent {
 ...
 DateTime get createdAt; Map<String, Object?> get custom; String? get feedVisibility; String get fid; String get memberId; DateTime? get receivedAt; String get type; UserResponseCommonFields? get user;
/// Create a copy of FeedMemberRemovedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeedMemberRemovedEventCopyWith<FeedMemberRemovedEvent> get copyWith => _$FeedMemberRemovedEventCopyWithImpl<FeedMemberRemovedEvent>(this as FeedMemberRemovedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedMemberRemovedEvent&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.feedVisibility, feedVisibility) || other.feedVisibility == feedVisibility)&&(identical(other.fid, fid) || other.fid == fid)&&(identical(other.memberId, memberId) || other.memberId == memberId)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}


@override
int get hashCode => Object.hash(runtimeType,createdAt,const DeepCollectionEquality().hash(custom),feedVisibility,fid,memberId,receivedAt,type,user);
...
abstract mixin class $FeedMemberRemovedEventCopyWith<$Res>  {
  factory $FeedMemberRemovedEventCopyWith(FeedMemberRemovedEvent value, $Res Function(FeedMemberRemovedEvent) _then) = _$FeedMemberRemovedEventCopyWithImpl;
@useResult
$Res call({
 DateTime createdAt, Map<String, Object?> custom, String? feedVisibility, String fid, String memberId, DateTime? receivedAt, String type, UserResponseCommonFields? user
});
...
/// Create a copy of FeedMemberRemovedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? custom = null,Object? feedVisibility = freezed,Object? fid = null,Object? memberId = null,Object? receivedAt = freezed,Object? type = null,Object? user = freezed,}) {
