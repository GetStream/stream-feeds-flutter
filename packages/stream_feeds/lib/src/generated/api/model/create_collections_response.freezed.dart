...
$CreateCollectionsResponseCopyWith<CreateCollectionsResponse> get copyWith => _$CreateCollectionsResponseCopyWithImpl<CreateCollectionsResponse>(this as CreateCollectionsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateCollectionsResponse&&const DeepCollectionEquality().equals(other.collections, collections)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $CreateCollectionsResponseCopyWith<$Res>  {
  factory $CreateCollectionsResponseCopyWith(CreateCollectionsResponse value, $Res Function(CreateCollectionsResponse) _then) = _$CreateCollectionsResponseCopyWithImpl;
@useResult
$Res call({
