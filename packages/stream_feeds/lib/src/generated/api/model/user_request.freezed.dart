...
mixin _$UserRequest {
 ...
 Map<String, Object?>? get custom; String get id; String? get image; bool? get invisible; String? get language; String? get name; PrivacySettingsResponse? get privacySettings;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserRequest&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.id, id) || other.id == id)&&(identical(other.image, image) || other.image == image)&&(identical(other.invisible, invisible) || other.invisible == invisible)&&(identical(other.language, language) || other.language == language)&&(identical(other.name, name) || other.name == name)&&(identical(other.privacySettings, privacySettings) || other.privacySettings == privacySettings));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(custom),id,image,invisible,language,name,privacySettings);
...
@useResult
$Res call({
 Map<String, Object?>? custom, String id, String? image, bool? invisible, String? language, String? name, PrivacySettingsResponse? privacySettings
});
...
/// Create a copy of UserRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? custom = freezed,Object? id = null,Object? image = freezed,Object? invisible = freezed,Object? language = freezed,Object? name = freezed,Object? privacySettings = freezed,}) {
