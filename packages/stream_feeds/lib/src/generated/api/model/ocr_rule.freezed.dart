...
mixin _$OCRRule {
 ...
 OCRRuleAction get action; String get label;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OCRRule&&(identical(other.action, action) || other.action == action)&&(identical(other.label, label) || other.label == label));
}
...
@useResult
$Res call({
 OCRRuleAction action, String label
});
...
/// @nodoc
class _$OCRRuleCopyWithImpl<$Res>
    implements $OCRRuleCopyWith<$Res> {
...
/// Create a copy of OCRRule
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? action = null,Object? label = null,}) {
