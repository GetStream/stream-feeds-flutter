...
mixin _$NotificationFeedUpdatedEvent {
 ...
 List<AggregatedActivityResponse>? get aggregatedActivities; DateTime get createdAt; Map<String, Object?> get custom; String? get feedVisibility; String get fid; NotificationStatusResponse? get notificationStatus; DateTime? get receivedAt; String get type; UserResponseCommonFields? get user;
/// Create a copy of NotificationFeedUpdatedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NotificationFeedUpdatedEventCopyWith<NotificationFeedUpdatedEvent> get copyWith => _$NotificationFeedUpdatedEventCopyWithImpl<NotificationFeedUpdatedEvent>(this as NotificationFeedUpdatedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationFeedUpdatedEvent&&const DeepCollectionEquality().equals(other.aggregatedActivities, aggregatedActivities)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.feedVisibility, feedVisibility) || other.feedVisibility == feedVisibility)&&(identical(other.fid, fid) || other.fid == fid)&&(identical(other.notificationStatus, notificationStatus) || other.notificationStatus == notificationStatus)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(aggregatedActivities),createdAt,const DeepCollectionEquality().hash(custom),feedVisibility,fid,notificationStatus,receivedAt,type,user);
...
abstract mixin class $NotificationFeedUpdatedEventCopyWith<$Res>  {
  factory $NotificationFeedUpdatedEventCopyWith(NotificationFeedUpdatedEvent value, $Res Function(NotificationFeedUpdatedEvent) _then) = _$NotificationFeedUpdatedEventCopyWithImpl;
@useResult
$Res call({
 List<AggregatedActivityResponse>? aggregatedActivities, DateTime createdAt, Map<String, Object?> custom, String? feedVisibility, String fid, NotificationStatusResponse? notificationStatus, DateTime? receivedAt, String type, UserResponseCommonFields? user
});
...
/// Create a copy of NotificationFeedUpdatedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? aggregatedActivities = freezed,Object? createdAt = null,Object? custom = null,Object? feedVisibility = freezed,Object? fid = null,Object? notificationStatus = freezed,Object? receivedAt = freezed,Object? type = null,Object? user = freezed,}) {
  return _then(NotificationFeedUpdatedEvent(
aggregatedActivities: freezed == aggregatedActivities ? _self.aggregatedActivities : aggregatedActivities // ignore: cast_nullable_to_non_nullable
