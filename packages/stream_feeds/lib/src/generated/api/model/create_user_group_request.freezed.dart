...
mixin _$CreateUserGroupRequest {
  ...
  $CreateUserGroupRequestCopyWith<CreateUserGroupRequest> get copyWith =>
      _$CreateUserGroupRequestCopyWithImpl<CreateUserGroupRequest>(
          this as CreateUserGroupRequest, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, description, id,
      const DeepCollectionEquality().hash(memberIds), name, teamId);
...
abstract mixin class $CreateUserGroupRequestCopyWith<$Res> {
  factory $CreateUserGroupRequestCopyWith(CreateUserGroupRequest value,
