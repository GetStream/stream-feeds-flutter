...
mixin _$CreateUserGroupRequest {
 ...
 String? get description; String? get id; List<String>? get memberIds; String get name; String? get teamId;
/// Create a copy of CreateUserGroupRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CreateUserGroupRequestCopyWith<CreateUserGroupRequest> get copyWith => _$CreateUserGroupRequestCopyWithImpl<CreateUserGroupRequest>(this as CreateUserGroupRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateUserGroupRequest&&(identical(other.description, description) || other.description == description)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.memberIds, memberIds)&&(identical(other.name, name) || other.name == name)&&(identical(other.teamId, teamId) || other.teamId == teamId));
}


@override
int get hashCode => Object.hash(runtimeType,description,id,const DeepCollectionEquality().hash(memberIds),name,teamId);
...
abstract mixin class $CreateUserGroupRequestCopyWith<$Res>  {
  factory $CreateUserGroupRequestCopyWith(CreateUserGroupRequest value, $Res Function(CreateUserGroupRequest) _then) = _$CreateUserGroupRequestCopyWithImpl;
@useResult
$Res call({
 String? description, String? id, List<String>? memberIds, String name, String? teamId
});
...
/// Create a copy of CreateUserGroupRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? description = freezed,Object? id = freezed,Object? memberIds = freezed,Object? name = null,Object? teamId = freezed,}) {
  return _then(CreateUserGroupRequest(
