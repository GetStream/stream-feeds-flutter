...
mixin _$ActivityResponse {
 ...
 List<Attachment> get attachments; int get bookmarkCount; Map<String, EnrichedCollectionResponse> get collections; int get commentCount; List<CommentResponse> get comments; DateTime get createdAt; FeedResponse? get currentFeed; Map<String, Object?> get custom; DateTime? get deletedAt; DateTime? get editedAt; DateTime? get expiresAt; List<String> get feeds; List<String> get filterTags; int? get friendReactionCount; List<FeedsReactionResponse>? get friendReactions; bool get hidden; String get id; List<String> get interestTags; bool? get isRead; bool? get isSeen; bool? get isWatched; List<FeedsReactionResponse> get latestReactions; Location? get location; List<UserResponse> get mentionedUsers; Map<String, int>? get metrics; ModerationV2Response? get moderation; String? get moderationAction; NotificationContext? get notificationContext; List<BookmarkResponse> get ownBookmarks; List<FeedsReactionResponse> get ownReactions; ActivityResponse? get parent; PollResponseData? get poll; int get popularity; bool get preview; int get reactionCount; Map<String, FeedsReactionGroupResponse> get reactionGroups; ActivityResponseRestrictReplies get restrictReplies; double get score; Map<String, Object?>? get scoreVars; Map<String, Object?> get searchData; String? get selectorSource; int get shareCount; String? get text; String get type; DateTime get updatedAt; UserResponse get user; ActivityResponseVisibility get visibility; String? get visibilityTag;
...
@useResult
$Res call({
 List<Attachment> attachments, int bookmarkCount, Map<String, EnrichedCollectionResponse> collections, int commentCount, List<CommentResponse> comments, DateTime createdAt, FeedResponse? currentFeed, Map<String, Object?> custom, DateTime? deletedAt, DateTime? editedAt, DateTime? expiresAt, List<String> feeds, List<String> filterTags, int? friendReactionCount, List<FeedsReactionResponse>? friendReactions, bool hidden, String id, List<String> interestTags, bool? isRead, bool? isSeen, bool? isWatched, List<FeedsReactionResponse> latestReactions, Location? location, List<UserResponse> mentionedUsers, Map<String, int>? metrics, ModerationV2Response? moderation, String? moderationAction, NotificationContext? notificationContext, List<BookmarkResponse> ownBookmarks, List<FeedsReactionResponse> ownReactions, ActivityResponse? parent, PollResponseData? poll, int popularity, bool preview, int reactionCount, Map<String, FeedsReactionGroupResponse> reactionGroups, ActivityResponseRestrictReplies restrictReplies, double score, Map<String, Object?>? scoreVars, Map<String, Object?> searchData, String? selectorSource, int shareCount, String? text, String type, DateTime updatedAt, UserResponse user, ActivityResponseVisibility visibility, String? visibilityTag
});
...
as Map<String, EnrichedCollectionResponse>,commentCount: null == commentCount ? _self.commentCount : commentCount // ignore: cast_nullable_to_non_nullable
as int,comments: null == comments ? _self.comments : comments // ignore: cast_nullable_to_non_nullable
as List<CommentResponse>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,currentFeed: freezed == currentFeed ? _self.currentFeed : currentFeed // ignore: cast_nullable_to_non_nullable
as FeedResponse?,custom: null == custom ? _self.custom : custom // ignore: cast_nullable_to_non_nullable
...
as Location?,mentionedUsers: null == mentionedUsers ? _self.mentionedUsers : mentionedUsers // ignore: cast_nullable_to_non_nullable
...
as List<BookmarkResponse>,ownReactions: null == ownReactions ? _self.ownReactions : ownReactions // ignore: cast_nullable_to_non_nullable
as List<FeedsReactionResponse>,parent: freezed == parent ? _self.parent : parent // ignore: cast_nullable_to_non_nullable
as ActivityResponse?,poll: freezed == poll ? _self.poll : poll // ignore: cast_nullable_to_non_nullable
...
as ActivityResponseRestrictReplies,score: null == score ? _self.score : score // ignore: cast_nullable_to_non_nullable
