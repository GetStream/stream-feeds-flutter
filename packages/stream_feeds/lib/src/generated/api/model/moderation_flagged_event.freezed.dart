...
mixin _$ModerationFlaggedEvent {
 ...
 String get contentType; DateTime get createdAt; Map<String, Object?> get custom; String get objectId; DateTime? get receivedAt; String get type;
/// Create a copy of ModerationFlaggedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ModerationFlaggedEventCopyWith<ModerationFlaggedEvent> get copyWith => _$ModerationFlaggedEventCopyWithImpl<ModerationFlaggedEvent>(this as ModerationFlaggedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModerationFlaggedEvent&&(identical(other.contentType, contentType) || other.contentType == contentType)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.objectId, objectId) || other.objectId == objectId)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type));
}


@override
int get hashCode => Object.hash(runtimeType,contentType,createdAt,const DeepCollectionEquality().hash(custom),objectId,receivedAt,type);
...
abstract mixin class $ModerationFlaggedEventCopyWith<$Res>  {
  factory $ModerationFlaggedEventCopyWith(ModerationFlaggedEvent value, $Res Function(ModerationFlaggedEvent) _then) = _$ModerationFlaggedEventCopyWithImpl;
@useResult
$Res call({
 String contentType, DateTime createdAt, Map<String, Object?> custom, String objectId, DateTime? receivedAt, String type
});
...
/// Create a copy of ModerationFlaggedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? contentType = null,Object? createdAt = null,Object? custom = null,Object? objectId = null,Object? receivedAt = freezed,Object? type = null,}) {
