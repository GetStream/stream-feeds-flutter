...
PollUpdatedFeedEvent _$PollUpdatedFeedEventFromJson(Map<String, dynamic> json) => PollUpdatedFeedEvent(
...
Map<String, dynamic> _$PollUpdatedFeedEventToJson(PollUpdatedFeedEvent instance) => <String, dynamic>{
