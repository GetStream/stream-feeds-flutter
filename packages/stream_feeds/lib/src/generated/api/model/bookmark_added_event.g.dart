...
BookmarkAddedEvent _$BookmarkAddedEventFromJson(Map<String, dynamic> json) => BookmarkAddedEvent(
...
Map<String, dynamic> _$BookmarkAddedEventToJson(BookmarkAddedEvent instance) => <String, dynamic>{
