...
$ContentCountRuleParametersCopyWith<ContentCountRuleParameters> get copyWith => _$ContentCountRuleParametersCopyWithImpl<ContentCountRuleParameters>(this as ContentCountRuleParameters, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ContentCountRuleParameters&&(identical(other.threshold, threshold) || other.threshold == threshold)&&(identical(other.timeWindow, timeWindow) || other.timeWindow == timeWindow));
}
...
abstract mixin class $ContentCountRuleParametersCopyWith<$Res>  {
  factory $ContentCountRuleParametersCopyWith(ContentCountRuleParameters value, $Res Function(ContentCountRuleParameters) _then) = _$ContentCountRuleParametersCopyWithImpl;
@useResult
$Res call({
