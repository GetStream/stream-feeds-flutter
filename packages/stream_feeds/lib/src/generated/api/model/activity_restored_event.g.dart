...
ActivityRestoredEvent _$ActivityRestoredEventFromJson(Map<String, dynamic> json) => ActivityRestoredEvent(
...
Map<String, dynamic> _$ActivityRestoredEventToJson(ActivityRestoredEvent instance) => <String, dynamic>{
