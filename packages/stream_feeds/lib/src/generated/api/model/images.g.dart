...
Images _$ImagesFromJson(Map<String, dynamic> json) => Images(
  ...
  fixedHeightDownsampled: ImageData.fromJson(json['fixed_height_downsampled'] as Map<String, dynamic>),
  fixedHeightStill: ImageData.fromJson(json['fixed_height_still'] as Map<String, dynamic>),
  fixedWidth: ImageData.fromJson(json['fixed_width'] as Map<String, dynamic>),
  fixedWidthDownsampled: ImageData.fromJson(json['fixed_width_downsampled'] as Map<String, dynamic>),
  fixedWidthStill: ImageData.fromJson(json['fixed_width_still'] as Map<String, dynamic>),
