...
class Message {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'before_message_send_failed': beforeMessageSendFailed,
      'cid': cid,
      'command': command,
    ...
    if (value is Map) {
      ...
      return Message(
        ...
        beforeMessageSendFailed:
            mapValueOfType<bool>(json, r'before_message_send_failed', null),
        ...
        pinnedBy: User.fromJson(json[r'pinned_by'] ?? null),
        poll: Poll.fromJson(json[r'poll'] ?? null),
        pollId: mapValueOfType<String>(json, r'poll_id', null),
        quotedMessage: Message.fromJson(json[r'quoted_message'] ?? null),
        quotedMessageId:
        ...
        reminder: MessageReminder.fromJson(json[r'reminder'] ?? null),
        ...
        sharedLocation:
            SharedLocation.fromJson(json[r'shared_location'] ?? null),
