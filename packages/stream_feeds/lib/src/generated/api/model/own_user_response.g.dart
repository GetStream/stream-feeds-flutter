...
OwnUserResponse _$OwnUserResponseFromJson(Map<String, dynamic> json) => OwnUserResponse(
  ...
  pushPreferences: json['push_preferences'] == null
      ? null
      : PushPreferencesResponse.fromJson(json['push_preferences'] as Map<String, dynamic>),
...
Map<String, dynamic> _$OwnUserResponseToJson(OwnUserResponse instance) => <String, dynamic>{
