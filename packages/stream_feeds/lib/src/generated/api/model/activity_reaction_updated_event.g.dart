...
class ActivityReactionUpdatedEvent {
  ...
  static ActivityReactionUpdatedEvent? fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();

      return ActivityReactionUpdatedEvent(
        ...
        type: mapValueOfType<String>(
            json, r'type', "feeds.activity.reaction.updated")!,
  ...
  static List<ActivityReactionUpdatedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityReactionUpdatedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityReactionUpdatedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is ActivityReactionUpdatedEvent &&
