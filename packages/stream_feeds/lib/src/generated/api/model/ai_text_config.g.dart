...
AITextConfig _$AITextConfigFromJson(Map<String, dynamic> json) => AITextConfig(
  ...
  rules:
      (json['rules'] as List<dynamic>?)?.map((e) => BodyguardRule.fromJson(e as Map<String, dynamic>)).toList() ?? [],
  severityRules:
...
Map<String, dynamic> _$AITextConfigToJson(AITextConfig instance) => <String, dynamic>{
