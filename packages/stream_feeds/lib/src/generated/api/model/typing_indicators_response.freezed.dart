...
$TypingIndicatorsResponseCopyWith<TypingIndicatorsResponse> get copyWith => _$TypingIndicatorsResponseCopyWithImpl<TypingIndicatorsResponse>(this as TypingIndicatorsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TypingIndicatorsResponse&&(identical(other.enabled, enabled) || other.enabled == enabled));
}
...
abstract mixin class $TypingIndicatorsResponseCopyWith<$Res>  {
  factory $TypingIndicatorsResponseCopyWith(TypingIndicatorsResponse value, $Res Function(TypingIndicatorsResponse) _then) = _$TypingIndicatorsResponseCopyWithImpl;
@useResult
$Res call({
 bool? enabled
});
