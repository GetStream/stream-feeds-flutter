...
CommentUpdatedEvent _$CommentUpdatedEventFromJson(Map<String, dynamic> json) => CommentUpdatedEvent(
...
Map<String, dynamic> _$CommentUpdatedEventToJson(CommentUpdatedEvent instance) => <String, dynamic>{
