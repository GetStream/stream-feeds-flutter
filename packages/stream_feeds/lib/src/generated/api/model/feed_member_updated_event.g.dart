...
FeedMemberUpdatedEvent _$FeedMemberUpdatedEventFromJson(Map<String, dynamic> json) => FeedMemberUpdatedEvent(
...
Map<String, dynamic> _$FeedMemberUpdatedEventToJson(FeedMemberUpdatedEvent instance) => <String, dynamic>{
