...
GetOGResponse _$GetOGResponseFromJson(Map<String, dynamic> json) => GetOGResponse(
  actions: (json['actions'] as List<dynamic>?)?.map((e) => Action.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  giphy: json['giphy'] == null ? null : Images.fromJson(json['giphy'] as Map<String, dynamic>),
...
Map<String, dynamic> _$GetOGResponseToJson(GetOGResponse instance) => <String, dynamic>{
