...
enum AddActivityRequestVisibilityEnum {
  ...
  static AddActivityRequestVisibilityEnum? fromValue(String? json) {
    switch (json) {
      case null:
        return null;
      case 'private':
        return AddActivityRequestVisibilityEnum.private;
      case 'public':
        return AddActivityRequestVisibilityEnum.public;
      case 'tag':
        return AddActivityRequestVisibilityEnum.tag;
      default:
        return AddActivityRequestVisibilityEnum.unknown;
    }
  }
}
...
class AddActivityRequest {
  ...
  static AddActivityRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AddActivityRequest(
        ...
        visibility:
            AddActivityRequestVisibilityEnum.fromValue(json['visibility']),
  ...
  static List<AddActivityRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <AddActivityRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AddActivityRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
