...
AddActivityRequest _$AddActivityRequestFromJson(Map<String, dynamic> json) => AddActivityRequest(
  ...
  restrictReplies: $enumDecodeNullable(
    _$AddActivityRequestRestrictRepliesEnumMap,
  ...
  visibility: $enumDecodeNullable(
    _$AddActivityRequestVisibilityEnumMap,
    json['visibility'],
...
Map<String, dynamic> _$AddActivityRequestToJson(AddActivityRequest instance) => <String, dynamic>{
  ...
  'restrict_replies': _$AddActivityRequestRestrictRepliesEnumMap[instance.restrictReplies],
