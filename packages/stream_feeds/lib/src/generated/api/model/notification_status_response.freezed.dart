...
mixin _$NotificationStatusResponse {
 ...
 DateTime? get lastReadAt; DateTime? get lastSeenAt; List<String>? get readActivities; List<String>? get seenActivities; int get unread; int get unseen;
/// Create a copy of NotificationStatusResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NotificationStatusResponseCopyWith<NotificationStatusResponse> get copyWith => _$NotificationStatusResponseCopyWithImpl<NotificationStatusResponse>(this as NotificationStatusResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationStatusResponse&&(identical(other.lastReadAt, lastReadAt) || other.lastReadAt == lastReadAt)&&(identical(other.lastSeenAt, lastSeenAt) || other.lastSeenAt == lastSeenAt)&&const DeepCollectionEquality().equals(other.readActivities, readActivities)&&const DeepCollectionEquality().equals(other.seenActivities, seenActivities)&&(identical(other.unread, unread) || other.unread == unread)&&(identical(other.unseen, unseen) || other.unseen == unseen));
}


@override
int get hashCode => Object.hash(runtimeType,lastReadAt,lastSeenAt,const DeepCollectionEquality().hash(readActivities),const DeepCollectionEquality().hash(seenActivities),unread,unseen);
...
abstract mixin class $NotificationStatusResponseCopyWith<$Res>  {
  factory $NotificationStatusResponseCopyWith(NotificationStatusResponse value, $Res Function(NotificationStatusResponse) _then) = _$NotificationStatusResponseCopyWithImpl;
@useResult
$Res call({
 DateTime? lastReadAt, DateTime? lastSeenAt, List<String>? readActivities, List<String>? seenActivities, int unread, int unseen
});
...
/// Create a copy of NotificationStatusResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lastReadAt = freezed,Object? lastSeenAt = freezed,Object? readActivities = freezed,Object? seenActivities = freezed,Object? unread = null,Object? unseen = null,}) {
...
as List<String>?,seenActivities: freezed == seenActivities ? _self.seenActivities : seenActivities // ignore: cast_nullable_to_non_nullable
as List<String>?,unread: null == unread ? _self.unread : unread // ignore: cast_nullable_to_non_nullable
