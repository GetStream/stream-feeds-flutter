...
$BookmarkDeletedEventCopyWith<BookmarkDeletedEvent> get copyWith => _$BookmarkDeletedEventCopyWithImpl<BookmarkDeletedEvent>(this as BookmarkDeletedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookmarkDeletedEvent&&(identical(other.bookmark, bookmark) || other.bookmark == bookmark)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}
...
abstract mixin class $BookmarkDeletedEventCopyWith<$Res>  {
  factory $BookmarkDeletedEventCopyWith(BookmarkDeletedEvent value, $Res Function(BookmarkDeletedEvent) _then) = _$BookmarkDeletedEventCopyWithImpl;
@useResult
$Res call({
