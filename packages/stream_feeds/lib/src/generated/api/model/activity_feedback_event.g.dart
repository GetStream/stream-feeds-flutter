...
ActivityFeedbackEvent _$ActivityFeedbackEventFromJson(Map<String, dynamic> json) => ActivityFeedbackEvent(
  activityFeedback: ActivityFeedbackEventPayload.fromJson(json['activity_feedback'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ActivityFeedbackEventToJson(ActivityFeedbackEvent instance) => <String, dynamic>{
