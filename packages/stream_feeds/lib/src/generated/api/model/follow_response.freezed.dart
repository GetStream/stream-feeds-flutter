...
mixin _$FollowResponse {
 ...
 DateTime get createdAt; Map<String, Object?>? get custom; String get followerRole; FollowResponsePushPreference get pushPreference; DateTime? get requestAcceptedAt; DateTime? get requestRejectedAt; FeedResponse get sourceFeed; FollowResponseStatus get status; FeedResponse get targetFeed; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,createdAt,const DeepCollectionEquality().hash(custom),followerRole,pushPreference,requestAcceptedAt,requestRejectedAt,sourceFeed,status,targetFeed,updatedAt);
...
@useResult
$Res call({
 DateTime createdAt, Map<String, Object?>? custom, String followerRole, FollowResponsePushPreference pushPreference, DateTime? requestAcceptedAt, DateTime? requestRejectedAt, FeedResponse sourceFeed, FollowResponseStatus status, FeedResponse targetFeed, DateTime updatedAt
});
...
/// Create a copy of FollowResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? custom = freezed,Object? followerRole = null,Object? pushPreference = null,Object? requestAcceptedAt = freezed,Object? requestRejectedAt = freezed,Object? sourceFeed = null,Object? status = null,Object? targetFeed = null,Object? updatedAt = null,}) {
...
as Map<String, Object?>?,followerRole: null == followerRole ? _self.followerRole : followerRole // ignore: cast_nullable_to_non_nullable
as String,pushPreference: null == pushPreference ? _self.pushPreference : pushPreference // ignore: cast_nullable_to_non_nullable
as FollowResponsePushPreference,requestAcceptedAt: freezed == requestAcceptedAt ? _self.requestAcceptedAt : requestAcceptedAt // ignore: cast_nullable_to_non_nullable
