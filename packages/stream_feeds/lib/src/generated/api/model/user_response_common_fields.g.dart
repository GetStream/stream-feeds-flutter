...
UserResponseCommonFields _$UserResponseCommonFieldsFromJson(Map<String, dynamic> json) => UserResponseCommonFields(
...
Map<String, dynamic> _$UserResponseCommonFieldsToJson(UserResponseCommonFields instance) => <String, dynamic>{
