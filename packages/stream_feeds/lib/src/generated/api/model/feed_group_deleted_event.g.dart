...
FeedGroupDeletedEvent _$FeedGroupDeletedEventFromJson(Map<String, dynamic> json) => FeedGroupDeletedEvent(
...
Map<String, dynamic> _$FeedGroupDeletedEventToJson(FeedGroupDeletedEvent instance) => <String, dynamic>{
