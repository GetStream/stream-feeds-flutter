...
class ActivityRemovedFromFeedEvent {
  ...
  static ActivityRemovedFromFeedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ActivityRemovedFromFeedEvent(
        ...
        type: mapValueOfType<String>(
            json, r'type', "feeds.activity.removed_from_feed")!,
  ...
  static List<ActivityRemovedFromFeedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityRemovedFromFeedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityRemovedFromFeedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is ActivityRemovedFromFeedEvent &&
