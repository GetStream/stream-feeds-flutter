...
mixin _$AddFolderRequest {
  ...
  $AddFolderRequestCopyWith<AddFolderRequest> get copyWith => _$AddFolderRequestCopyWithImpl<AddFolderRequest>(
    this as AddFolderRequest,
    _$identity,
  );
...
abstract mixin class $AddFolderRequestCopyWith<$Res> {
  factory $AddFolderRequestCopyWith(
    AddFolderRequest value,
    $Res Function(AddFolderRequest) _then,
...
/// @nodoc
class _$AddFolderRequestCopyWithImpl<$Res> implements $AddFolderRequestCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? custom = freezed, Object? name = null}) {
    return _then(
      AddFolderRequest(
