...
class CallParticipant {
  ...
  static CallParticipant? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CallParticipant(
        ...
        joinedAt: mapValueOfType<DateTime>(json, r'JoinedAt')!,
        ...
        userSessionID: mapValueOfType<String>(json, r'UserSessionID')!,
      );
    }
    return null;
  }

  static List<CallParticipant> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CallParticipant.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
