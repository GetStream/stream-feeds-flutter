...
mixin _$EnrichedCollectionResponse {
 ...
 DateTime? get createdAt; Map<String, Object?>? get custom; String get id; String get name; EnrichedCollectionResponseStatus get status; DateTime? get updatedAt; String? get userId;
/// Create a copy of EnrichedCollectionResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EnrichedCollectionResponseCopyWith<EnrichedCollectionResponse> get copyWith => _$EnrichedCollectionResponseCopyWithImpl<EnrichedCollectionResponse>(this as EnrichedCollectionResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EnrichedCollectionResponse&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.userId, userId) || other.userId == userId));
}
...
abstract mixin class $EnrichedCollectionResponseCopyWith<$Res>  {
  factory $EnrichedCollectionResponseCopyWith(EnrichedCollectionResponse value, $Res Function(EnrichedCollectionResponse) _then) = _$EnrichedCollectionResponseCopyWithImpl;
@useResult
$Res call({
 DateTime? createdAt, Map<String, Object?>? custom, String id, String name, EnrichedCollectionResponseStatus status, DateTime? updatedAt, String? userId
});
...
/// Create a copy of EnrichedCollectionResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = freezed,Object? custom = freezed,Object? id = null,Object? name = null,Object? status = null,Object? updatedAt = freezed,Object? userId = freezed,}) {
...
as EnrichedCollectionResponseStatus,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
