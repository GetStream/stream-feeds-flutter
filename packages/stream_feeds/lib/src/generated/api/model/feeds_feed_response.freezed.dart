...
mixin _$FeedsFeedResponse {
 ...
 int get activityCount; DateTime get createdAt; UserResponse get createdBy; Map<String, Object?>? get custom; DateTime? get deletedAt; String get description; String get feed; List<String>? get filterTags; int get followerCount; int get followingCount; String get groupId; String get id; FeedsActivityLocation? get location; int get memberCount; String get name; int get pinCount; DateTime get updatedAt; String? get visibility;
/// Create a copy of FeedsFeedResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeedsFeedResponseCopyWith<FeedsFeedResponse> get copyWith => _$FeedsFeedResponseCopyWithImpl<FeedsFeedResponse>(this as FeedsFeedResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedsFeedResponse&&(identical(other.activityCount, activityCount) || other.activityCount == activityCount)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.description, description) || other.description == description)&&(identical(other.feed, feed) || other.feed == feed)&&const DeepCollectionEquality().equals(other.filterTags, filterTags)&&(identical(other.followerCount, followerCount) || other.followerCount == followerCount)&&(identical(other.followingCount, followingCount) || other.followingCount == followingCount)&&(identical(other.groupId, groupId) || other.groupId == groupId)&&(identical(other.id, id) || other.id == id)&&(identical(other.location, location) || other.location == location)&&(identical(other.memberCount, memberCount) || other.memberCount == memberCount)&&(identical(other.name, name) || other.name == name)&&(identical(other.pinCount, pinCount) || other.pinCount == pinCount)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.visibility, visibility) || other.visibility == visibility));
}


@override
int get hashCode => Object.hash(runtimeType,activityCount,createdAt,createdBy,const DeepCollectionEquality().hash(custom),deletedAt,description,feed,const DeepCollectionEquality().hash(filterTags),followerCount,followingCount,groupId,id,location,memberCount,name,pinCount,updatedAt,visibility);
...
abstract mixin class $FeedsFeedResponseCopyWith<$Res>  {
  factory $FeedsFeedResponseCopyWith(FeedsFeedResponse value, $Res Function(FeedsFeedResponse) _then) = _$FeedsFeedResponseCopyWithImpl;
@useResult
$Res call({
 int activityCount, DateTime createdAt, UserResponse createdBy, Map<String, Object?>? custom, DateTime? deletedAt, String description, String feed, List<String>? filterTags, int followerCount, int followingCount, String groupId, String id, FeedsActivityLocation? location, int memberCount, String name, int pinCount, DateTime updatedAt, String? visibility
});
...
as FeedsActivityLocation?,memberCount: null == memberCount ? _self.memberCount : memberCount // ignore: cast_nullable_to_non_nullable
