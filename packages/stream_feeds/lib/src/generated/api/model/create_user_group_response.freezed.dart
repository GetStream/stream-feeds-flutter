...
$CreateUserGroupResponseCopyWith<CreateUserGroupResponse> get copyWith => _$CreateUserGroupResponseCopyWithImpl<CreateUserGroupResponse>(this as CreateUserGroupResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateUserGroupResponse&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.userGroup, userGroup) || other.userGroup == userGroup));
}
...
abstract mixin class $CreateUserGroupResponseCopyWith<$Res>  {
  factory $CreateUserGroupResponseCopyWith(CreateUserGroupResponse value, $Res Function(CreateUserGroupResponse) _then) = _$CreateUserGroupResponseCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? duration = null,Object? userGroup = freezed,}) {
  return _then(CreateUserGroupResponse(
