...
$RemoveUserGroupMembersResponseCopyWith<RemoveUserGroupMembersResponse> get copyWith => _$RemoveUserGroupMembersResponseCopyWithImpl<RemoveUserGroupMembersResponse>(this as RemoveUserGroupMembersResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RemoveUserGroupMembersResponse&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.userGroup, userGroup) || other.userGroup == userGroup));
}
...
abstract mixin class $RemoveUserGroupMembersResponseCopyWith<$Res>  {
  factory $RemoveUserGroupMembersResponseCopyWith(RemoveUserGroupMembersResponse value, $Res Function(RemoveUserGroupMembersResponse) _then) = _$RemoveUserGroupMembersResponseCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? duration = null,Object? userGroup = freezed,}) {
  return _then(RemoveUserGroupMembersResponse(
