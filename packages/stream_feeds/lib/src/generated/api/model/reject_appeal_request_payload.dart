...
part 'reject_appeal_request_payload.g.dart';
part 'reject_appeal_request_payload.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class RejectAppealRequestPayload with _$RejectAppealRequestPayload {
  const RejectAppealRequestPayload({
