...
part 'get_config_response.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class GetConfigResponse with _$GetConfigResponse {
  ...
  static GetConfigResponse fromJson(Map<String, dynamic> json) => _$GetConfigResponseFromJson(json);
}
