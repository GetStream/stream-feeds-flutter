...
mixin _$EntityCreator {
  ...
  /// Create a copy of EntityCreator
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $EntityCreatorCopyWith<EntityCreator> get copyWith =>
      _$EntityCreatorCopyWithImpl<EntityCreator>(
          this as EntityCreator, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EntityCreator &&
  ...
  @override
  String toString() {
    return 'EntityCreator(avgResponseTime: $avgResponseTime, banCount: $banCount, banExpires: $banExpires, banned: $banned, createdAt: $createdAt, custom: $custom, deactivatedAt: $deactivatedAt, deletedAt: $deletedAt, deletedContentCount: $deletedContentCount, id: $id, invisible: $invisible, language: $language, lastActive: $lastActive, lastEngagedAt: $lastEngagedAt, online: $online, privacySettings: $privacySettings, revokeTokensIssuedBefore: $revokeTokensIssuedBefore, role: $role, teams: $teams, teamsRole: $teamsRole, updatedAt: $updatedAt)';
  }
}

/// @nodoc
abstract mixin class $EntityCreatorCopyWith<$Res> {
  factory $EntityCreatorCopyWith(
          EntityCreator value, $Res Function(EntityCreator) _then) =
      _$EntityCreatorCopyWithImpl;
  @useResult
  $Res call(
      {int? avgResponseTime,
      int banCount,
...
/// @nodoc
class _$EntityCreatorCopyWithImpl<$Res>
    implements $EntityCreatorCopyWith<$Res> {
  _$EntityCreatorCopyWithImpl(this._self, this._then);

  final EntityCreator _self;
  final $Res Function(EntityCreator) _then;
