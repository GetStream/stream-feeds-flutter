...
mixin _$ChatMessageResponse {
  ...
  String? get mml;
  ChatModerationV2Response? get moderation;
  List<ChatReactionResponse> get ownReactions;
  String? get parentId;
  ...
  Map<String, ChatReactionGroupResponse>? get reactionGroups;
  Map<String, int> get reactionScores;
  ChatReminderResponseData? get reminder;
  int get replyCount;
  List<String> get restrictedVisibility;
  bool get shadowed;
  ChatSharedLocationResponseData? get sharedLocation;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.mentionedGroupIds, mentionedGroupIds) &&
            const DeepCollectionEquality()
                .equals(other.mentionedGroups, mentionedGroups) &&
            (identical(other.mentionedHere, mentionedHere) ||
                other.mentionedHere == mentionedHere) &&
            const DeepCollectionEquality()
                .equals(other.mentionedRoles, mentionedRoles) &&
            const DeepCollectionEquality()
...
abstract mixin class $ChatMessageResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? mml,
      ChatModerationV2Response? moderation,
      List<ChatReactionResponse> ownReactions,
      String? parentId,
      DateTime? pinExpires,
      bool pinned,
      DateTime? pinnedAt,
      ...
      Map<String, ChatReactionGroupResponse>? reactionGroups,
      Map<String, int> reactionScores,
      ChatReminderResponseData? reminder,
      int replyCount,
      List<String> restrictedVisibility,
      bool shadowed,
      ChatSharedLocationResponseData? sharedLocation,
      bool? showInChannel,
      bool silent,
      String text,
    ...
    return _then(ChatMessageResponse(
      ...
      reactionGroups: freezed == reactionGroups
          ...
          : reactionGroups // ignore: cast_nullable_to_non_nullable
              as Map<String, ChatReactionGroupResponse>?,
      ...
      sharedLocation: freezed == sharedLocation
          ...
          : sharedLocation // ignore: cast_nullable_to_non_nullable
              as ChatSharedLocationResponseData?,
