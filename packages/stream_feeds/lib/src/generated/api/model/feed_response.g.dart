...
FeedResponse _$FeedResponseFromJson(Map<String, dynamic> json) => FeedResponse(
      ...
      ownCapabilities: (json['own_capabilities'] as List<dynamic>?)
          ?.map((e) => $enumDecode(_$FeedResponseOwnCapabilitiesEnumMap, e,
      ...
      visibility: $enumDecodeNullable(
          _$FeedResponseVisibilityEnumMap, json['visibility'],
...
Map<String, dynamic> _$FeedResponseToJson(FeedResponse instance) =>
    <String, dynamic>{
      ...
      'own_capabilities': instance.ownCapabilities
          ?.map((e) => _$FeedResponseOwnCapabilitiesEnumMap[e]!)
          .toList(),
...
const _$FeedResponseOwnCapabilitiesEnumMap = {
  ...
  FeedResponseOwnCapabilities.deleteOwnActivityBookmark:
      'delete-own-activity-bookmark',
  FeedResponseOwnCapabilities.deleteOwnActivityReaction:
      'delete-own-activity-reaction',
  FeedResponseOwnCapabilities.deleteOwnComment: 'delete-own-comment',
  FeedResponseOwnCapabilities.deleteOwnCommentReaction:
  ...
  FeedResponseOwnCapabilities.updateOwnActivityBookmark:
