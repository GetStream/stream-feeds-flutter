...
SingleFollowResponse _$SingleFollowResponseFromJson(Map<String, dynamic> json) => SingleFollowResponse(
...
Map<String, dynamic> _$SingleFollowResponseToJson(SingleFollowResponse instance) => <String, dynamic>{
