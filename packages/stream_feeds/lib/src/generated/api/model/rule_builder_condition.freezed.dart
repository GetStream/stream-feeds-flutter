  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                  other.callCustomPropertyParams,
            ...
            (identical(
                  other.callViolationCountParams,
...
abstract mixin class $RuleBuilderConditionCopyWith<$Res> {
  factory $RuleBuilderConditionCopyWith(
    RuleBuilderCondition value,
  ...
  $Res call({
    ...
    return _then(
      RuleBuilderCondition(
        ...
        userFlagCountRuleParams: freezed == userFlagCountRuleParams
