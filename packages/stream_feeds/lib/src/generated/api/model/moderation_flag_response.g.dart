...
ModerationFlagResponse _$ModerationFlagResponseFromJson(Map<String, dynamic> json) => ModerationFlagResponse(
...
Map<String, dynamic> _$ModerationFlagResponseToJson(ModerationFlagResponse instance) => <String, dynamic>{
