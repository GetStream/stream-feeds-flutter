...
$ReactionGroupUserResponseCopyWith<ReactionGroupUserResponse> get copyWith => _$ReactionGroupUserResponseCopyWithImpl<ReactionGroupUserResponse>(this as ReactionGroupUserResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReactionGroupUserResponse&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.user, user) || other.user == user)&&(identical(other.userId, userId) || other.userId == userId));
}
...
abstract mixin class $ReactionGroupUserResponseCopyWith<$Res>  {
  factory $ReactionGroupUserResponseCopyWith(ReactionGroupUserResponse value, $Res Function(ReactionGroupUserResponse) _then) = _$ReactionGroupUserResponseCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? user = freezed,Object? userId = null,}) {
  return _then(ReactionGroupUserResponse(
