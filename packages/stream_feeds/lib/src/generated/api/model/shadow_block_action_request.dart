...
part 'shadow_block_action_request.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class ShadowBlockActionRequest with _$ShadowBlockActionRequest {
  const ShadowBlockActionRequest({
    this.reason,
  });
  ...
  static ShadowBlockActionRequest fromJson(Map<String, dynamic> json) =>
