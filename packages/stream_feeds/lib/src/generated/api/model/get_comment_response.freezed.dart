...
$GetCommentResponseCopyWith<GetCommentResponse> get copyWith => _$GetCommentResponseCopyWithImpl<GetCommentResponse>(this as GetCommentResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetCommentResponse&&(identical(other.comment, comment) || other.comment == comment)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $GetCommentResponseCopyWith<$Res>  {
  factory $GetCommentResponseCopyWith(GetCommentResponse value, $Res Function(GetCommentResponse) _then) = _$GetCommentResponseCopyWithImpl;
@useResult
$Res call({
