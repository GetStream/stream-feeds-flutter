...
class VideoRuleParameters {
  ...
  static VideoRuleParameters? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<VideoRuleParameters> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <VideoRuleParameters>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VideoRuleParameters.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is VideoRuleParameters &&
