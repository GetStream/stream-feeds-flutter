...
$DeleteCommentBookmarkResponseCopyWith<DeleteCommentBookmarkResponse> get copyWith => _$DeleteCommentBookmarkResponseCopyWithImpl<DeleteCommentBookmarkResponse>(this as DeleteCommentBookmarkResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteCommentBookmarkResponse&&(identical(other.bookmark, bookmark) || other.bookmark == bookmark)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $DeleteCommentBookmarkResponseCopyWith<$Res>  {
  factory $DeleteCommentBookmarkResponseCopyWith(DeleteCommentBookmarkResponse value, $Res Function(DeleteCommentBookmarkResponse) _then) = _$DeleteCommentBookmarkResponseCopyWithImpl;
@useResult
$Res call({
