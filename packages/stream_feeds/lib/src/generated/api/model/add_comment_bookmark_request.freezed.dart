...
$AddCommentBookmarkRequestCopyWith<AddCommentBookmarkRequest> get copyWith => _$AddCommentBookmarkRequestCopyWithImpl<AddCommentBookmarkRequest>(this as AddCommentBookmarkRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddCommentBookmarkRequest&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.folderId, folderId) || other.folderId == folderId)&&(identical(other.newFolder, newFolder) || other.newFolder == newFolder));
}
...
abstract mixin class $AddCommentBookmarkRequestCopyWith<$Res>  {
  factory $AddCommentBookmarkRequestCopyWith(AddCommentBookmarkRequest value, $Res Function(AddCommentBookmarkRequest) _then) = _$AddCommentBookmarkRequestCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AddCommentBookmarkRequestCopyWithImpl<$Res>
    implements $AddCommentBookmarkRequestCopyWith<$Res> {
...
@pragma('vm:prefer-inline') @override $Res call({Object? custom = freezed,Object? folderId = freezed,Object? newFolder = freezed,}) {
  return _then(AddCommentBookmarkRequest(
