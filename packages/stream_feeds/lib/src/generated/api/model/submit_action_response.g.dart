...
SubmitActionResponse _$SubmitActionResponseFromJson(Map<String, dynamic> json) => SubmitActionResponse(
...
Map<String, dynamic> _$SubmitActionResponseToJson(SubmitActionResponse instance) => <String, dynamic>{
