...
mixin _$GetOrCreateFollowResponse {
 ...
 bool get created; String get duration; FollowResponse get follow; bool? get notificationCreated;
/// Create a copy of GetOrCreateFollowResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GetOrCreateFollowResponseCopyWith<GetOrCreateFollowResponse> get copyWith => _$GetOrCreateFollowResponseCopyWithImpl<GetOrCreateFollowResponse>(this as GetOrCreateFollowResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetOrCreateFollowResponse&&(identical(other.created, created) || other.created == created)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.follow, follow) || other.follow == follow)&&(identical(other.notificationCreated, notificationCreated) || other.notificationCreated == notificationCreated));
}


@override
int get hashCode => Object.hash(runtimeType,created,duration,follow,notificationCreated);
...
abstract mixin class $GetOrCreateFollowResponseCopyWith<$Res>  {
  factory $GetOrCreateFollowResponseCopyWith(GetOrCreateFollowResponse value, $Res Function(GetOrCreateFollowResponse) _then) = _$GetOrCreateFollowResponseCopyWithImpl;
@useResult
$Res call({
 bool created, String duration, FollowResponse follow, bool? notificationCreated
});
...
/// Create a copy of GetOrCreateFollowResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? created = null,Object? duration = null,Object? follow = null,Object? notificationCreated = freezed,}) {
