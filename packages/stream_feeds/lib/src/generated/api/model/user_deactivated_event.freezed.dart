...
$UserDeactivatedEventCopyWith<UserDeactivatedEvent> get copyWith => _$UserDeactivatedEventCopyWithImpl<UserDeactivatedEvent>(this as UserDeactivatedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserDeactivatedEvent&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}
...
abstract mixin class $UserDeactivatedEventCopyWith<$Res>  {
  factory $UserDeactivatedEventCopyWith(UserDeactivatedEvent value, $Res Function(UserDeactivatedEvent) _then) = _$UserDeactivatedEventCopyWithImpl;
@useResult
$Res call({
