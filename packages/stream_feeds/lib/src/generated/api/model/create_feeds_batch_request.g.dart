...
CreateFeedsBatchRequest _$CreateFeedsBatchRequestFromJson(Map<String, dynamic> json) => CreateFeedsBatchRequest(
...
Map<String, dynamic> _$CreateFeedsBatchRequestToJson(CreateFeedsBatchRequest instance) => <String, dynamic>{
