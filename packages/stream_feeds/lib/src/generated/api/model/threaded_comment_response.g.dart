...
ThreadedCommentResponse _$ThreadedCommentResponseFromJson(Map<String, dynamic> json) => ThreadedCommentResponse(
  ...
  mentionedUsers: (json['mentioned_users'] as List<dynamic>)
      ...
      .toList(),
  meta: json['meta'] == null ? null : RepliesMeta.fromJson(json['meta'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ThreadedCommentResponseToJson(ThreadedCommentResponse instance) => <String, dynamic>{
