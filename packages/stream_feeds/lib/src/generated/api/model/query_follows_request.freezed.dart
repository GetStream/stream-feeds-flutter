...
/// Create a copy of QueryFollowsRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$QueryFollowsRequestCopyWith<QueryFollowsRequest> get copyWith => _$QueryFollowsRequestCopyWithImpl<QueryFollowsRequest>(this as QueryFollowsRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryFollowsRequest&&const DeepCollectionEquality().equals(other.filter, filter)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.sort, sort));
}
...
@override
String toString() {
  return 'QueryFollowsRequest(filter: $filter, limit: $limit, next: $next, prev: $prev, sort: $sort)';
}
...
/// @nodoc
abstract mixin class $QueryFollowsRequestCopyWith<$Res>  {
  factory $QueryFollowsRequestCopyWith(QueryFollowsRequest value, $Res Function(QueryFollowsRequest) _then) = _$QueryFollowsRequestCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$QueryFollowsRequestCopyWithImpl<$Res>
    implements $QueryFollowsRequestCopyWith<$Res> {
  _$QueryFollowsRequestCopyWithImpl(this._self, this._then);

  final QueryFollowsRequest _self;
  final $Res Function(QueryFollowsRequest) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? filter = freezed,Object? limit = freezed,Object? next = freezed,Object? prev = freezed,Object? sort = freezed,}) {
  return _then(QueryFollowsRequest(
