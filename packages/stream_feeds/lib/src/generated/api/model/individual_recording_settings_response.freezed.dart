...
mixin _$IndividualRecordingSettingsResponse {
  ...
  $IndividualRecordingSettingsResponseCopyWith<
      ...
      get copyWith => _$IndividualRecordingSettingsResponseCopyWithImpl<
              IndividualRecordingSettingsResponse>(
  ...
  @override
  String toString() {
    return 'IndividualRecordingSettingsResponse(mode: $mode)';
  }
}
...
abstract mixin class $IndividualRecordingSettingsResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({IndividualRecordingSettingsResponseMode mode});
}
