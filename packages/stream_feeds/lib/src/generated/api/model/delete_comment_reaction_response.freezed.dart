...
mixin _$DeleteCommentReactionResponse {
 ...
 CommentResponse get comment; String get duration; FeedsReactionResponse get reaction;
/// Create a copy of DeleteCommentReactionResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DeleteCommentReactionResponseCopyWith<DeleteCommentReactionResponse> get copyWith => _$DeleteCommentReactionResponseCopyWithImpl<DeleteCommentReactionResponse>(this as DeleteCommentReactionResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteCommentReactionResponse&&(identical(other.comment, comment) || other.comment == comment)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.reaction, reaction) || other.reaction == reaction));
}
...
abstract mixin class $DeleteCommentReactionResponseCopyWith<$Res>  {
  factory $DeleteCommentReactionResponseCopyWith(DeleteCommentReactionResponse value, $Res Function(DeleteCommentReactionResponse) _then) = _$DeleteCommentReactionResponseCopyWithImpl;
@useResult
$Res call({
 CommentResponse comment, String duration, FeedsReactionResponse reaction
});
...
/// Create a copy of DeleteCommentReactionResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? comment = null,Object? duration = null,Object? reaction = null,}) {
