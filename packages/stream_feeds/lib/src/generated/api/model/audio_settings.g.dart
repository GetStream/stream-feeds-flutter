...
AudioSettings _$AudioSettingsFromJson(Map<String, dynamic> json) =>
    AudioSettings(
      ...
      defaultDevice: $enumDecode(
          _$AudioSettingsDefaultDeviceEnumMap, json['default_device'],
          unknownValue: AudioSettingsDefaultDevice.unknown),
...
Map<String, dynamic> _$AudioSettingsToJson(AudioSettings instance) =>
    <String, dynamic>{
      ...
      'default_device':
          _$AudioSettingsDefaultDeviceEnumMap[instance.defaultDevice]!,
...
const _$AudioSettingsDefaultDeviceEnumMap = {
  AudioSettingsDefaultDevice.earpiece: 'earpiece',
  AudioSettingsDefaultDevice.speaker: 'speaker',
  AudioSettingsDefaultDevice.unknown: '_unknown',
};
