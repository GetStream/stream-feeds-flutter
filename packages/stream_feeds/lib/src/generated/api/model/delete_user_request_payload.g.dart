...
DeleteUserRequestPayload _$DeleteUserRequestPayloadFromJson(Map<String, dynamic> json) => DeleteUserRequestPayload(
...
Map<String, dynamic> _$DeleteUserRequestPayloadToJson(DeleteUserRequestPayload instance) => <String, dynamic>{
