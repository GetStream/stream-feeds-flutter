...
RuleBuilderRule _$RuleBuilderRuleFromJson(Map<String, dynamic> json) => RuleBuilderRule(
  action: json['action'] == null ? null : RuleBuilderAction.fromJson(json['action'] as Map<String, dynamic>),
  actionSequences: (json['action_sequences'] as List<dynamic>?)
      ?.map((e) => CallRuleActionSequence.fromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  groups: (json['groups'] as List<dynamic>?)
      ?.map((e) => RuleBuilderConditionGroup.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$RuleBuilderRuleToJson(RuleBuilderRule instance) => <String, dynamic>{
