...
mixin _$DeleteActivityReactionResponse {
 ...
 ActivityResponse get activity; String get duration; FeedsReactionResponse get reaction;
/// Create a copy of DeleteActivityReactionResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DeleteActivityReactionResponseCopyWith<DeleteActivityReactionResponse> get copyWith => _$DeleteActivityReactionResponseCopyWithImpl<DeleteActivityReactionResponse>(this as DeleteActivityReactionResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteActivityReactionResponse&&(identical(other.activity, activity) || other.activity == activity)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.reaction, reaction) || other.reaction == reaction));
}
...
abstract mixin class $DeleteActivityReactionResponseCopyWith<$Res>  {
  factory $DeleteActivityReactionResponseCopyWith(DeleteActivityReactionResponse value, $Res Function(DeleteActivityReactionResponse) _then) = _$DeleteActivityReactionResponseCopyWithImpl;
@useResult
$Res call({
 ActivityResponse activity, String duration, FeedsReactionResponse reaction
});
...
/// Create a copy of DeleteActivityReactionResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activity = null,Object? duration = null,Object? reaction = null,}) {
