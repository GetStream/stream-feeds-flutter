...
$BlockActionRequestPayloadCopyWith<BlockActionRequestPayload> get copyWith => _$BlockActionRequestPayloadCopyWithImpl<BlockActionRequestPayload>(this as BlockActionRequestPayload, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BlockActionRequestPayload&&(identical(other.reason, reason) || other.reason == reason));
}
...
abstract mixin class $BlockActionRequestPayloadCopyWith<$Res>  {
  factory $BlockActionRequestPayloadCopyWith(BlockActionRequestPayload value, $Res Function(BlockActionRequestPayload) _then) = _$BlockActionRequestPayloadCopyWithImpl;
@useResult
$Res call({
 String? reason
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? reason = freezed,}) {
  return _then(BlockActionRequestPayload(
