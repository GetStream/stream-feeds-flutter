...
$BulkDeleteActionConfigResponseCopyWith<BulkDeleteActionConfigResponse> get copyWith => _$BulkDeleteActionConfigResponseCopyWithImpl<BulkDeleteActionConfigResponse>(this as BulkDeleteActionConfigResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BulkDeleteActionConfigResponse&&(identical(other.deleted, deleted) || other.deleted == deleted)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $BulkDeleteActionConfigResponseCopyWith<$Res>  {
  factory $BulkDeleteActionConfigResponseCopyWith(BulkDeleteActionConfigResponse value, $Res Function(BulkDeleteActionConfigResponse) _then) = _$BulkDeleteActionConfigResponseCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? deleted = null,Object? duration = null,}) {
  return _then(BulkDeleteActionConfigResponse(
