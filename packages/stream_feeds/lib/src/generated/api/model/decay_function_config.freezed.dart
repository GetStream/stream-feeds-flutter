...
mixin _$DecayFunctionConfig {
 ...
 String? get base; String? get decay; String? get direction; String? get offset; String? get origin; String? get scale;
/// Create a copy of DecayFunctionConfig
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DecayFunctionConfigCopyWith<DecayFunctionConfig> get copyWith => _$DecayFunctionConfigCopyWithImpl<DecayFunctionConfig>(this as DecayFunctionConfig, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DecayFunctionConfig&&(identical(other.base, base) || other.base == base)&&(identical(other.decay, decay) || other.decay == decay)&&(identical(other.direction, direction) || other.direction == direction)&&(identical(other.offset, offset) || other.offset == offset)&&(identical(other.origin, origin) || other.origin == origin)&&(identical(other.scale, scale) || other.scale == scale));
}


@override
int get hashCode => Object.hash(runtimeType,base,decay,direction,offset,origin,scale);
...
abstract mixin class $DecayFunctionConfigCopyWith<$Res>  {
  factory $DecayFunctionConfigCopyWith(DecayFunctionConfig value, $Res Function(DecayFunctionConfig) _then) = _$DecayFunctionConfigCopyWithImpl;
@useResult
$Res call({
 String? base, String? decay, String? direction, String? offset, String? origin, String? scale
});
...
/// Create a copy of DecayFunctionConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? base = freezed,Object? decay = freezed,Object? direction = freezed,Object? offset = freezed,Object? origin = freezed,Object? scale = freezed,}) {
