...
$QueryPollsRequestCopyWith<QueryPollsRequest> get copyWith => _$QueryPollsRequestCopyWithImpl<QueryPollsRequest>(this as QueryPollsRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryPollsRequest&&const DeepCollectionEquality().equals(other.filter, filter)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.sort, sort));
}
...
abstract mixin class $QueryPollsRequestCopyWith<$Res>  {
  factory $QueryPollsRequestCopyWith(QueryPollsRequest value, $Res Function(QueryPollsRequest) _then) = _$QueryPollsRequestCopyWithImpl;
@useResult
$Res call({
