...
FileUploadConfig _$FileUploadConfigFromJson(Map<String, dynamic> json) => FileUploadConfig(
...
Map<String, dynamic> _$FileUploadConfigToJson(FileUploadConfig instance) => <String, dynamic>{
