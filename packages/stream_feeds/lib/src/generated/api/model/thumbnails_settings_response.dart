...
part 'thumbnails_settings_response.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class ThumbnailsSettingsResponse with _$ThumbnailsSettingsResponse {
  ...
  static ThumbnailsSettingsResponse fromJson(Map<String, dynamic> json) =>
