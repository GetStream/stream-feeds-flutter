...
$QueryPollVotesRequestCopyWith<QueryPollVotesRequest> get copyWith => _$QueryPollVotesRequestCopyWithImpl<QueryPollVotesRequest>(this as QueryPollVotesRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryPollVotesRequest&&const DeepCollectionEquality().equals(other.filter, filter)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.sort, sort));
}
...
abstract mixin class $QueryPollVotesRequestCopyWith<$Res>  {
  factory $QueryPollVotesRequestCopyWith(QueryPollVotesRequest value, $Res Function(QueryPollVotesRequest) _then) = _$QueryPollVotesRequestCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? filter = freezed,Object? limit = freezed,Object? next = freezed,Object? prev = freezed,Object? sort = freezed,}) {
  return _then(QueryPollVotesRequest(
