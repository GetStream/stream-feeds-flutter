...
mixin _$EnrichmentOptions {
  ...
  $EnrichmentOptionsCopyWith<EnrichmentOptions> get copyWith =>
      _$EnrichmentOptionsCopyWithImpl<EnrichmentOptions>(
          this as EnrichmentOptions, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.skipActivityCurrentFeed, skipActivityCurrentFeed) ||
                other.skipActivityCurrentFeed == skipActivityCurrentFeed) &&
            (identical(other.skipActivityMentionedUsers, skipActivityMentionedUsers) ||
            ...
            (identical(other.skipActivityPoll, skipActivityPoll) ||
                other.skipActivityPoll == skipActivityPoll) &&
            (identical(other.skipActivityReactions, skipActivityReactions) ||
                other.skipActivityReactions == skipActivityReactions) &&
            (identical(other.skipActivityRefreshImageUrls,
            ...
            (identical(other.skipFollowers, skipFollowers) ||
                other.skipFollowers == skipFollowers) &&
            (identical(other.skipFollowing, skipFollowing) ||
            ...
            (identical(other.skipOwnFollows, skipOwnFollows) ||
                other.skipOwnFollows == skipOwnFollows) &&
...
abstract mixin class $EnrichmentOptionsCopyWith<$Res> {
  factory $EnrichmentOptionsCopyWith(
          EnrichmentOptions value, $Res Function(EnrichmentOptions) _then) =
