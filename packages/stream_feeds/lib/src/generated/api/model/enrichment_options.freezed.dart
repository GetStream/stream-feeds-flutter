...
/// @nodoc
class _$EnrichmentOptionsCopyWithImpl<$Res>
    implements $EnrichmentOptionsCopyWith<$Res> {
...
/// Create a copy of EnrichmentOptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enrichOwnFollowings = freezed,Object? includeFlatActivities = freezed,Object? includeScoreVars = freezed,Object? skipActivity = freezed,Object? skipActivityCollections = freezed,Object? skipActivityComments = freezed,Object? skipActivityCurrentFeed = freezed,Object? skipActivityMentionedUsers = freezed,Object? skipActivityOwnBookmarks = freezed,Object? skipActivityParents = freezed,Object? skipActivityPoll = freezed,Object? skipActivityReactions = freezed,Object? skipActivityRefreshImageUrls = freezed,Object? skipAll = freezed,Object? skipFeedMemberUser = freezed,Object? skipFollowers = freezed,Object? skipFollowing = freezed,Object? skipOwnCapabilities = freezed,Object? skipOwnFollows = freezed,Object? skipPins = freezed,}) {
  return _then(EnrichmentOptions(
enrichOwnFollowings: freezed == enrichOwnFollowings ? _self.enrichOwnFollowings : enrichOwnFollowings // ignore: cast_nullable_to_non_nullable
as bool?,includeFlatActivities: freezed == includeFlatActivities ? _self.includeFlatActivities : includeFlatActivities // ignore: cast_nullable_to_non_nullable
as bool?,includeScoreVars: freezed == includeScoreVars ? _self.includeScoreVars : includeScoreVars // ignore: cast_nullable_to_non_nullable
as bool?,skipActivity: freezed == skipActivity ? _self.skipActivity : skipActivity // ignore: cast_nullable_to_non_nullable
...
as bool?,skipActivityMentionedUsers: freezed == skipActivityMentionedUsers ? _self.skipActivityMentionedUsers : skipActivityMentionedUsers // ignore: cast_nullable_to_non_nullable
...
as bool?,skipActivityReactions: freezed == skipActivityReactions ? _self.skipActivityReactions : skipActivityReactions // ignore: cast_nullable_to_non_nullable
...
as bool?,skipFollowing: freezed == skipFollowing ? _self.skipFollowing : skipFollowing // ignore: cast_nullable_to_non_nullable
as bool?,skipOwnCapabilities: freezed == skipOwnCapabilities ? _self.skipOwnCapabilities : skipOwnCapabilities // ignore: cast_nullable_to_non_nullable
as bool?,skipOwnFollows: freezed == skipOwnFollows ? _self.skipOwnFollows : skipOwnFollows // ignore: cast_nullable_to_non_nullable
as bool?,skipPins: freezed == skipPins ? _self.skipPins : skipPins // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
