...
FeedUpdatedEvent _$FeedUpdatedEventFromJson(Map<String, dynamic> json) => FeedUpdatedEvent(
...
Map<String, dynamic> _$FeedUpdatedEventToJson(FeedUpdatedEvent instance) => <String, dynamic>{
