...
abstract mixin class $ChannelResponseCopyWith<$Res>  {
  factory $ChannelResponseCopyWith(ChannelResponse value, $Res Function(ChannelResponse) _then) = _$ChannelResponseCopyWithImpl;
@useResult
$Res call({
 bool? autoTranslationEnabled, String? autoTranslationLanguage, bool? blocked, String cid, ChannelConfigWithInfo? config, int? cooldown, DateTime createdAt, UserResponse? createdBy, Map<String, Object?> custom, DateTime? deletedAt, bool disabled, List<String>? filterTags, bool frozen, bool? hidden, DateTime? hideMessagesBefore, String id, DateTime? lastMessageAt, int? memberCount, List<ChannelMemberResponse>? members, int? messageCount, DateTime? muteExpiresAt, bool? muted, List<ChannelResponseOwnCapabilities>? ownCapabilities, String? team, DateTime? truncatedAt, UserResponse? truncatedBy, String type, DateTime updatedAt
});
...
/// Create a copy of ChannelResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? autoTranslationEnabled = freezed,Object? autoTranslationLanguage = freezed,Object? blocked = freezed,Object? cid = null,Object? config = freezed,Object? cooldown = freezed,Object? createdAt = null,Object? createdBy = freezed,Object? custom = null,Object? deletedAt = freezed,Object? disabled = null,Object? filterTags = freezed,Object? frozen = null,Object? hidden = freezed,Object? hideMessagesBefore = freezed,Object? id = null,Object? lastMessageAt = freezed,Object? memberCount = freezed,Object? members = freezed,Object? messageCount = freezed,Object? muteExpiresAt = freezed,Object? muted = freezed,Object? ownCapabilities = freezed,Object? team = freezed,Object? truncatedAt = freezed,Object? truncatedBy = freezed,Object? type = null,Object? updatedAt = null,}) {
...
as bool?,autoTranslationLanguage: freezed == autoTranslationLanguage ? _self.autoTranslationLanguage : autoTranslationLanguage // ignore: cast_nullable_to_non_nullable
...
as ChannelConfigWithInfo?,cooldown: freezed == cooldown ? _self.cooldown : cooldown // ignore: cast_nullable_to_non_nullable
as int?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,createdBy: freezed == createdBy ? _self.createdBy : createdBy // ignore: cast_nullable_to_non_nullable
as UserResponse?,custom: null == custom ? _self.custom : custom // ignore: cast_nullable_to_non_nullable
...
as bool,filterTags: freezed == filterTags ? _self.filterTags : filterTags // ignore: cast_nullable_to_non_nullable
as List<String>?,frozen: null == frozen ? _self.frozen : frozen // ignore: cast_nullable_to_non_nullable
...
as List<ChannelMemberResponse>?,messageCount: freezed == messageCount ? _self.messageCount : messageCount // ignore: cast_nullable_to_non_nullable
...
as bool?,ownCapabilities: freezed == ownCapabilities ? _self.ownCapabilities : ownCapabilities // ignore: cast_nullable_to_non_nullable
as List<ChannelResponseOwnCapabilities>?,team: freezed == team ? _self.team : team // ignore: cast_nullable_to_non_nullable
as String?,truncatedAt: freezed == truncatedAt ? _self.truncatedAt : truncatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,truncatedBy: freezed == truncatedBy ? _self.truncatedBy : truncatedBy // ignore: cast_nullable_to_non_nullable
