...
AppEventResponse _$AppEventResponseFromJson(Map<String, dynamic> json) => AppEventResponse(
...
Map<String, dynamic> _$AppEventResponseToJson(AppEventResponse instance) => <String, dynamic>{
