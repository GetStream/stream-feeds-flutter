...
PollVoteChangedFeedEvent _$PollVoteChangedFeedEventFromJson(Map<String, dynamic> json) => PollVoteChangedFeedEvent(
...
Map<String, dynamic> _$PollVoteChangedFeedEventToJson(PollVoteChangedFeedEvent instance) => <String, dynamic>{
