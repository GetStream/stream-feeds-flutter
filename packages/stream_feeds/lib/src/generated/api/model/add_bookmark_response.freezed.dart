...
$AddBookmarkResponseCopyWith<AddBookmarkResponse> get copyWith => _$AddBookmarkResponseCopyWithImpl<AddBookmarkResponse>(this as AddBookmarkResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddBookmarkResponse&&(identical(other.bookmark, bookmark) || other.bookmark == bookmark)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $AddBookmarkResponseCopyWith<$Res>  {
  factory $AddBookmarkResponseCopyWith(AddBookmarkResponse value, $Res Function(AddBookmarkResponse) _then) = _$AddBookmarkResponseCopyWithImpl;
@useResult
$Res call({
