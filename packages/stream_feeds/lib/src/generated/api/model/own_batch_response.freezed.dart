...
mixin _$OwnBatchResponse {
  ...
  $OwnBatchResponseCopyWith<OwnBatchResponse> get copyWith => _$OwnBatchResponseCopyWithImpl<OwnBatchResponse>(
    this as OwnBatchResponse,
    _$identity,
  );
...
abstract mixin class $OwnBatchResponseCopyWith<$Res> {
  factory $OwnBatchResponseCopyWith(
    OwnBatchResponse value,
    $Res Function(OwnBatchResponse) _then,
...
/// @nodoc
class _$OwnBatchResponseCopyWithImpl<$Res> implements $OwnBatchResponseCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? data = null, Object? duration = null}) {
    return _then(
      OwnBatchResponse(
        data: null == data
            ? _self.data
