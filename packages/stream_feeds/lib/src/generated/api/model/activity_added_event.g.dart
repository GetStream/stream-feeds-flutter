...
class ActivityAddedEvent {
  ...
  static ActivityAddedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ActivityAddedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.activity.added")!,
  ...
  static List<ActivityAddedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityAddedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityAddedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
