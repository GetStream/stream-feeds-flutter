...
class BookmarkFolderUpdatedEvent {
  ...
  static BookmarkFolderUpdatedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return BookmarkFolderUpdatedEvent(
        ...
        type: mapValueOfType<String>(
            json, r'type', "feeds.bookmark_folder.updated")!,
  ...
  static List<BookmarkFolderUpdatedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <BookmarkFolderUpdatedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BookmarkFolderUpdatedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
