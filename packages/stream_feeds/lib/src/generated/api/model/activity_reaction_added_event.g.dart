...
class ActivityReactionAddedEvent {
  ...
  static ActivityReactionAddedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ActivityReactionAddedEvent(
        ...
        type: mapValueOfType<String>(
            json, r'type', "feeds.activity.reaction.added")!,
  ...
  static List<ActivityReactionAddedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityReactionAddedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityReactionAddedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
