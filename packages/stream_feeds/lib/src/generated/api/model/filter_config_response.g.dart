...
FilterConfigResponse _$FilterConfigResponseFromJson(Map<String, dynamic> json) => FilterConfigResponse(
...
Map<String, dynamic> _$FilterConfigResponseToJson(FilterConfigResponse instance) => <String, dynamic>{
