...
part 'unmute_request.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class UnmuteRequest with _$UnmuteRequest {
  const UnmuteRequest({
  ...
  static UnmuteRequest fromJson(Map<String, dynamic> json) => _$UnmuteRequestFromJson(json);
}
