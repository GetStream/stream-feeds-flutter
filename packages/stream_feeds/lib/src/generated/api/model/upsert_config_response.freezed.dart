...
$UpsertConfigResponseCopyWith<UpsertConfigResponse> get copyWith => _$UpsertConfigResponseCopyWithImpl<UpsertConfigResponse>(this as UpsertConfigResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpsertConfigResponse&&(identical(other.config, config) || other.config == config)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $UpsertConfigResponseCopyWith<$Res>  {
  factory $UpsertConfigResponseCopyWith(UpsertConfigResponse value, $Res Function(UpsertConfigResponse) _then) = _$UpsertConfigResponseCopyWithImpl;
@useResult
$Res call({
