...
/// @nodoc
mixin _$QueryPinnedActivitiesRequest {
...
/// Create a copy of QueryPinnedActivitiesRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$QueryPinnedActivitiesRequestCopyWith<QueryPinnedActivitiesRequest> get copyWith => _$QueryPinnedActivitiesRequestCopyWithImpl<QueryPinnedActivitiesRequest>(this as QueryPinnedActivitiesRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryPinnedActivitiesRequest&&(identical(other.enrichOwnFields, enrichOwnFields) || other.enrichOwnFields == enrichOwnFields)&&const DeepCollectionEquality().equals(other.filter, filter)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.sort, sort));
}
...
@override
String toString() {
  return 'QueryPinnedActivitiesRequest(enrichOwnFields: $enrichOwnFields, filter: $filter, limit: $limit, next: $next, prev: $prev, sort: $sort)';
}
...
/// @nodoc
abstract mixin class $QueryPinnedActivitiesRequestCopyWith<$Res>  {
  factory $QueryPinnedActivitiesRequestCopyWith(QueryPinnedActivitiesRequest value, $Res Function(QueryPinnedActivitiesRequest) _then) = _$QueryPinnedActivitiesRequestCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$QueryPinnedActivitiesRequestCopyWithImpl<$Res>
    implements $QueryPinnedActivitiesRequestCopyWith<$Res> {
  _$QueryPinnedActivitiesRequestCopyWithImpl(this._self, this._then);

  final QueryPinnedActivitiesRequest _self;
  final $Res Function(QueryPinnedActivitiesRequest) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? enrichOwnFields = freezed,Object? filter = freezed,Object? limit = freezed,Object? next = freezed,Object? prev = freezed,Object? sort = freezed,}) {
  return _then(QueryPinnedActivitiesRequest(
