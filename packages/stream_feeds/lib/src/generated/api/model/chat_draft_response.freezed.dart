...
mixin _$ChatDraftResponse {
 ...
 String get channelCid; DateTime get createdAt; ChatDraftPayloadResponse get message; String? get parentId; ChatMessageResponse? get parentMessage; ChatMessageResponse? get quotedMessage;
...
@override
int get hashCode => Object.hash(runtimeType,channelCid,createdAt,message,parentId,parentMessage,quotedMessage);
...
@useResult
$Res call({
 String channelCid, DateTime createdAt, ChatDraftPayloadResponse message, String? parentId, ChatMessageResponse? parentMessage, ChatMessageResponse? quotedMessage
});
...
/// Create a copy of ChatDraftResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? channelCid = null,Object? createdAt = null,Object? message = null,Object? parentId = freezed,Object? parentMessage = freezed,Object? quotedMessage = freezed,}) {
  return _then(ChatDraftResponse(
...
as ChatDraftPayloadResponse,parentId: freezed == parentId ? _self.parentId : parentId // ignore: cast_nullable_to_non_nullable
as String?,parentMessage: freezed == parentMessage ? _self.parentMessage : parentMessage // ignore: cast_nullable_to_non_nullable
as ChatMessageResponse?,quotedMessage: freezed == quotedMessage ? _self.quotedMessage : quotedMessage // ignore: cast_nullable_to_non_nullable
