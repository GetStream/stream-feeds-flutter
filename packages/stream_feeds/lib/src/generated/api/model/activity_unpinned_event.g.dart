...
ActivityUnpinnedEvent _$ActivityUnpinnedEventFromJson(Map<String, dynamic> json) => ActivityUnpinnedEvent(
  ...
  pinnedActivity: PinActivityResponse.fromJson(json['pinned_activity'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ActivityUnpinnedEventToJson(ActivityUnpinnedEvent instance) => <String, dynamic>{
