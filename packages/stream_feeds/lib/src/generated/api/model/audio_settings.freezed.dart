...
mixin _$AudioSettings {
  ...
  AudioSettingsDefaultDevice get defaultDevice;
  ...
  $AudioSettingsCopyWith<AudioSettings> get copyWith =>
      _$AudioSettingsCopyWithImpl<AudioSettings>(
          this as AudioSettings, _$identity);
  ...
  @override
  String toString() {
    return 'AudioSettings(accessRequestEnabled: $accessRequestEnabled, defaultDevice: $defaultDevice, micDefaultOn: $micDefaultOn, noiseCancellation: $noiseCancellation, opusDtxEnabled: $opusDtxEnabled, redundantCodingEnabled: $redundantCodingEnabled, speakerDefaultOn: $speakerDefaultOn)';
  }
}
...
abstract mixin class $AudioSettingsCopyWith<$Res> {
  factory $AudioSettingsCopyWith(
          AudioSettings value, $Res Function(AudioSettings) _then) =
      _$AudioSettingsCopyWithImpl;
  @useResult
  $Res call(
      {bool accessRequestEnabled,
      AudioSettingsDefaultDevice defaultDevice,
      bool micDefaultOn,
