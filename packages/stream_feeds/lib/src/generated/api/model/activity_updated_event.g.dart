...
ActivityUpdatedEvent _$ActivityUpdatedEventFromJson(Map<String, dynamic> json) => ActivityUpdatedEvent(
...
Map<String, dynamic> _$ActivityUpdatedEventToJson(ActivityUpdatedEvent instance) => <String, dynamic>{
