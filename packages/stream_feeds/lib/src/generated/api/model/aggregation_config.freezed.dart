...
mixin _$AggregationConfig {
 ...
 String? get activitiesSort; String? get format; int? get groupSize; String? get scoreStrategy;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AggregationConfig&&(identical(other.activitiesSort, activitiesSort) || other.activitiesSort == activitiesSort)&&(identical(other.format, format) || other.format == format)&&(identical(other.groupSize, groupSize) || other.groupSize == groupSize)&&(identical(other.scoreStrategy, scoreStrategy) || other.scoreStrategy == scoreStrategy));
}


@override
int get hashCode => Object.hash(runtimeType,activitiesSort,format,groupSize,scoreStrategy);
...
@useResult
$Res call({
 String? activitiesSort, String? format, int? groupSize, String? scoreStrategy
});
...
/// Create a copy of AggregationConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activitiesSort = freezed,Object? format = freezed,Object? groupSize = freezed,Object? scoreStrategy = freezed,}) {
  return _then(AggregationConfig(
activitiesSort: freezed == activitiesSort ? _self.activitiesSort : activitiesSort // ignore: cast_nullable_to_non_nullable
...
as int?,scoreStrategy: freezed == scoreStrategy ? _self.scoreStrategy : scoreStrategy // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
