...
ChannelResponse _$ChannelResponseFromJson(Map<String, dynamic> json) =>
    ChannelResponse(
      ...
      ownCapabilities: (json['own_capabilities'] as List<dynamic>?)
          ?.map((e) => $enumDecode(_$ChannelResponseOwnCapabilitiesEnumMap, e,
...
Map<String, dynamic> _$ChannelResponseToJson(ChannelResponse instance) =>
    <String, dynamic>{
      ...
      'own_capabilities': instance.ownCapabilities
          ?.map((e) => _$ChannelResponseOwnCapabilitiesEnumMap[e]!)
          .toList(),
      'team': instance.team,
...
const _$ChannelResponseOwnCapabilitiesEnumMap = {
  ...
  ChannelResponseOwnCapabilities.sendRestrictedVisibilityMessage:
