...
QueryFeedsRequest _$QueryFeedsRequestFromJson(Map<String, dynamic> json) => QueryFeedsRequest(
...
Map<String, dynamic> _$QueryFeedsRequestToJson(QueryFeedsRequest instance) => <String, dynamic>{
