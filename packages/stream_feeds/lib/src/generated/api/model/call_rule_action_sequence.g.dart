...
CallRuleActionSequence _$CallRuleActionSequenceFromJson(Map<String, dynamic> json) => CallRuleActionSequence(
...
Map<String, dynamic> _$CallRuleActionSequenceToJson(CallRuleActionSequence instance) => <String, dynamic>{
