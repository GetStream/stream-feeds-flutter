...
FeedGroupChangedEvent _$FeedGroupChangedEventFromJson(Map<String, dynamic> json) => FeedGroupChangedEvent(
...
Map<String, dynamic> _$FeedGroupChangedEventToJson(FeedGroupChangedEvent instance) => <String, dynamic>{
