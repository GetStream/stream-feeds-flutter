...
mixin _$NotificationConfig {
 ...
 String? get deduplicationWindow; bool? get trackRead; bool? get trackSeen;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationConfig&&(identical(other.deduplicationWindow, deduplicationWindow) || other.deduplicationWindow == deduplicationWindow)&&(identical(other.trackRead, trackRead) || other.trackRead == trackRead)&&(identical(other.trackSeen, trackSeen) || other.trackSeen == trackSeen));
}


@override
int get hashCode => Object.hash(runtimeType,deduplicationWindow,trackRead,trackSeen);
...
@useResult
$Res call({
 String? deduplicationWindow, bool? trackRead, bool? trackSeen
});
...
/// Create a copy of NotificationConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? deduplicationWindow = freezed,Object? trackRead = freezed,Object? trackSeen = freezed,}) {
