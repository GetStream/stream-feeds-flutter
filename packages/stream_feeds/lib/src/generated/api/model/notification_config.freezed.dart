...
mixin _$NotificationConfig {
  ...
  $NotificationConfigCopyWith<NotificationConfig> get copyWith => _$NotificationConfigCopyWithImpl<NotificationConfig>(
    this as NotificationConfig,
    _$identity,
  );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.trackRead, trackRead) || other.trackRead == trackRead) &&
            (identical(other.trackSeen, trackSeen) || other.trackSeen == trackSeen));
  }
...
abstract mixin class $NotificationConfigCopyWith<$Res> {
  factory $NotificationConfigCopyWith(
    ...
    $Res Function(NotificationConfig) _then,
...
/// @nodoc
class _$NotificationConfigCopyWithImpl<$Res> implements $NotificationConfigCopyWith<$Res> {
