...
mixin _$StoriesConfig {
  ...
  $StoriesConfigCopyWith<StoriesConfig> get copyWith => _$StoriesConfigCopyWithImpl<StoriesConfig>(
    this as StoriesConfig,
    _$identity,
  );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.skipWatched, skipWatched) || other.skipWatched == skipWatched) &&
            (identical(other.trackWatched, trackWatched) || other.trackWatched == trackWatched));
  }
...
abstract mixin class $StoriesConfigCopyWith<$Res> {
  factory $StoriesConfigCopyWith(
    StoriesConfig value,
    $Res Function(StoriesConfig) _then,
...
/// @nodoc
class _$StoriesConfigCopyWithImpl<$Res> implements $StoriesConfigCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? skipWatched = freezed, Object? trackWatched = freezed}) {
    return _then(
      StoriesConfig(
