...
FriendReactionsOptions _$FriendReactionsOptionsFromJson(Map<String, dynamic> json) => FriendReactionsOptions(
...
Map<String, dynamic> _$FriendReactionsOptionsToJson(FriendReactionsOptions instance) => <String, dynamic>{
