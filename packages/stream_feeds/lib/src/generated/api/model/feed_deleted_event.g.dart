...
class FeedDeletedEvent {
  ...
  static FeedDeletedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return FeedDeletedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.feed.deleted")!,
  ...
  static List<FeedDeletedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <FeedDeletedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FeedDeletedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
