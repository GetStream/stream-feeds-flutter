...
part 'flag_count_rule_parameters.g.dart';
part 'flag_count_rule_parameters.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class FlagCountRuleParameters with _$FlagCountRuleParameters {
  const FlagCountRuleParameters({
    this.threshold,
  });
