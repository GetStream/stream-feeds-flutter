...
FeedGroupRestoredEvent _$FeedGroupRestoredEventFromJson(Map<String, dynamic> json) => FeedGroupRestoredEvent(
...
Map<String, dynamic> _$FeedGroupRestoredEventToJson(FeedGroupRestoredEvent instance) => <String, dynamic>{
