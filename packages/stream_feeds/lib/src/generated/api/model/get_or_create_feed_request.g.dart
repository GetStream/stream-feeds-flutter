...
GetOrCreateFeedRequest _$GetOrCreateFeedRequestFromJson(Map<String, dynamic> json) => GetOrCreateFeedRequest(
  data: json['data'] == null ? null : FeedInput.fromJson(json['data'] as Map<String, dynamic>),
  enrichmentOptions: json['enrichment_options'] == null
      ? null
      : EnrichmentOptions.fromJson(json['enrichment_options'] as Map<String, dynamic>),
  externalRanking: json['external_ranking'] as Map<String, dynamic>?,
  filter: json['filter'] as Map<String, dynamic>?,
  followersPagination: json['followers_pagination'] == null
      ? null
      : PagerRequest.fromJson(json['followers_pagination'] as Map<String, dynamic>),
  followingPagination: json['following_pagination'] == null
      ? null
      : PagerRequest.fromJson(json['following_pagination'] as Map<String, dynamic>),
  friendReactionsOptions: json['friend_reactions_options'] == null
      ? null
      : FriendReactionsOptions.fromJson(json['friend_reactions_options'] as Map<String, dynamic>),
  ...
  memberPagination: json['member_pagination'] == null
      ? null
      : PagerRequest.fromJson(json['member_pagination'] as Map<String, dynamic>),
...
Map<String, dynamic> _$GetOrCreateFeedRequestToJson(GetOrCreateFeedRequest instance) => <String, dynamic>{
