...
$DeleteReactionRequestPayloadCopyWith<DeleteReactionRequestPayload> get copyWith => _$DeleteReactionRequestPayloadCopyWithImpl<DeleteReactionRequestPayload>(this as DeleteReactionRequestPayload, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteReactionRequestPayload&&(identical(other.entityId, entityId) || other.entityId == entityId)&&(identical(other.entityType, entityType) || other.entityType == entityType)&&(identical(other.hardDelete, hardDelete) || other.hardDelete == hardDelete)&&(identical(other.reason, reason) || other.reason == reason));
}
...
abstract mixin class $DeleteReactionRequestPayloadCopyWith<$Res>  {
  factory $DeleteReactionRequestPayloadCopyWith(DeleteReactionRequestPayload value, $Res Function(DeleteReactionRequestPayload) _then) = _$DeleteReactionRequestPayloadCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? entityId = freezed,Object? entityType = freezed,Object? hardDelete = freezed,Object? reason = freezed,}) {
  return _then(DeleteReactionRequestPayload(
