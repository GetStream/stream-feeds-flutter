...
$UpdateActivityResponseCopyWith<UpdateActivityResponse> get copyWith => _$UpdateActivityResponseCopyWithImpl<UpdateActivityResponse>(this as UpdateActivityResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateActivityResponse&&(identical(other.activity, activity) || other.activity == activity)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $UpdateActivityResponseCopyWith<$Res>  {
  factory $UpdateActivityResponseCopyWith(UpdateActivityResponse value, $Res Function(UpdateActivityResponse) _then) = _$UpdateActivityResponseCopyWithImpl;
@useResult
$Res call({
