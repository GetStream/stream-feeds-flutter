...
DeleteActivitiesRequest _$DeleteActivitiesRequestFromJson(Map<String, dynamic> json) => DeleteActivitiesRequest(
  deleteNotificationActivity: json['delete_notification_activity'] as bool?,
  hardDelete: json['hard_delete'] as bool?,
  ids: (json['ids'] as List<dynamic>).map((e) => e as String).toList(),
);

Map<String, dynamic> _$DeleteActivitiesRequestToJson(DeleteActivitiesRequest instance) => <String, dynamic>{
