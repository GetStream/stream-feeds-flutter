...
$FeedGroupDeletedEventCopyWith<FeedGroupDeletedEvent> get copyWith => _$FeedGroupDeletedEventCopyWithImpl<FeedGroupDeletedEvent>(this as FeedGroupDeletedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedGroupDeletedEvent&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.feedVisibility, feedVisibility) || other.feedVisibility == feedVisibility)&&(identical(other.fid, fid) || other.fid == fid)&&(identical(other.groupId, groupId) || other.groupId == groupId)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type));
}
...
abstract mixin class $FeedGroupDeletedEventCopyWith<$Res>  {
  factory $FeedGroupDeletedEventCopyWith(FeedGroupDeletedEvent value, $Res Function(FeedGroupDeletedEvent) _then) = _$FeedGroupDeletedEventCopyWithImpl;
@useResult
$Res call({
