...
part 'custom_action_request.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class CustomActionRequest with _$CustomActionRequest {
  ...
  static CustomActionRequest fromJson(Map<String, dynamic> json) =>
