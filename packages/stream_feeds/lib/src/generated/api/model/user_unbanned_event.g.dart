...
UserUnbannedEvent _$UserUnbannedEventFromJson(Map<String, dynamic> json) => UserUnbannedEvent(
...
Map<String, dynamic> _$UserUnbannedEventToJson(UserUnbannedEvent instance) => <String, dynamic>{
