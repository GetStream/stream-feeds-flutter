...
SubmitActionRequest _$SubmitActionRequestFromJson(Map<String, dynamic> json) => SubmitActionRequest(
  ...
  block: json['block'] == null ? null : BlockActionRequestPayload.fromJson(json['block'] as Map<String, dynamic>),
  bypass: json['bypass'] == null ? null : BypassActionRequest.fromJson(json['bypass'] as Map<String, dynamic>),
  custom: json['custom'] == null ? null : CustomActionRequestPayload.fromJson(json['custom'] as Map<String, dynamic>),
  deleteActivity: json['delete_activity'] == null
      ? null
      : DeleteActivityRequestPayload.fromJson(json['delete_activity'] as Map<String, dynamic>),
  deleteComment: json['delete_comment'] == null
      ? null
      : DeleteCommentRequestPayload.fromJson(json['delete_comment'] as Map<String, dynamic>),
  deleteMessage: json['delete_message'] == null
      ? null
      : DeleteMessageRequestPayload.fromJson(json['delete_message'] as Map<String, dynamic>),
  deleteReaction: json['delete_reaction'] == null
      ? null
      : DeleteReactionRequestPayload.fromJson(json['delete_reaction'] as Map<String, dynamic>),
  deleteUser: json['delete_user'] == null
      ? null
      : DeleteUserRequestPayload.fromJson(json['delete_user'] as Map<String, dynamic>),
  ...
  shadowBlock: json['shadow_block'] == null
      ? null
      : ShadowBlockActionRequestPayload.fromJson(json['shadow_block'] as Map<String, dynamic>),
...
Map<String, dynamic> _$SubmitActionRequestToJson(SubmitActionRequest instance) => <String, dynamic>{
