...
UpdateBlockListRequest _$UpdateBlockListRequestFromJson(Map<String, dynamic> json) => UpdateBlockListRequest(
...
Map<String, dynamic> _$UpdateBlockListRequestToJson(UpdateBlockListRequest instance) => <String, dynamic>{
