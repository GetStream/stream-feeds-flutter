...
mixin _$CommentReactionDeletedEvent {
 ...
 CommentResponse get comment; DateTime get createdAt; Map<String, Object?> get custom; String? get feedVisibility; String get fid; FeedsReactionResponse get reaction; DateTime? get receivedAt; String get type;
/// Create a copy of CommentReactionDeletedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CommentReactionDeletedEventCopyWith<CommentReactionDeletedEvent> get copyWith => _$CommentReactionDeletedEventCopyWithImpl<CommentReactionDeletedEvent>(this as CommentReactionDeletedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentReactionDeletedEvent&&(identical(other.comment, comment) || other.comment == comment)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.feedVisibility, feedVisibility) || other.feedVisibility == feedVisibility)&&(identical(other.fid, fid) || other.fid == fid)&&(identical(other.reaction, reaction) || other.reaction == reaction)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type));
}


@override
int get hashCode => Object.hash(runtimeType,comment,createdAt,const DeepCollectionEquality().hash(custom),feedVisibility,fid,reaction,receivedAt,type);
...
abstract mixin class $CommentReactionDeletedEventCopyWith<$Res>  {
  factory $CommentReactionDeletedEventCopyWith(CommentReactionDeletedEvent value, $Res Function(CommentReactionDeletedEvent) _then) = _$CommentReactionDeletedEventCopyWithImpl;
@useResult
$Res call({
 CommentResponse comment, DateTime createdAt, Map<String, Object?> custom, String? feedVisibility, String fid, FeedsReactionResponse reaction, DateTime? receivedAt, String type
});
...
/// Create a copy of CommentReactionDeletedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? comment = null,Object? createdAt = null,Object? custom = null,Object? feedVisibility = freezed,Object? fid = null,Object? reaction = null,Object? receivedAt = freezed,Object? type = null,}) {
