...
$QueryCommentReactionsRequestCopyWith<QueryCommentReactionsRequest> get copyWith => _$QueryCommentReactionsRequestCopyWithImpl<QueryCommentReactionsRequest>(this as QueryCommentReactionsRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryCommentReactionsRequest&&const DeepCollectionEquality().equals(other.filter, filter)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.sort, sort));
}
...
abstract mixin class $QueryCommentReactionsRequestCopyWith<$Res>  {
  factory $QueryCommentReactionsRequestCopyWith(QueryCommentReactionsRequest value, $Res Function(QueryCommentReactionsRequest) _then) = _$QueryCommentReactionsRequestCopyWithImpl;
@useResult
$Res call({
