...
mixin _$PushNotificationConfig {
 ...
 bool? get enablePush; List<String>? get pushTypes;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PushNotificationConfig&&(identical(other.enablePush, enablePush) || other.enablePush == enablePush)&&const DeepCollectionEquality().equals(other.pushTypes, pushTypes));
}


@override
int get hashCode => Object.hash(runtimeType,enablePush,const DeepCollectionEquality().hash(pushTypes));
...
@useResult
$Res call({
 bool? enablePush, List<String>? pushTypes
});
...
/// Create a copy of PushNotificationConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enablePush = freezed,Object? pushTypes = freezed,}) {
