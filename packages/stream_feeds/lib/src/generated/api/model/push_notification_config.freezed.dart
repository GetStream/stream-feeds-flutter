...
mixin _$PushNotificationConfig {
  ...
  $PushNotificationConfigCopyWith<PushNotificationConfig> get copyWith =>
      _$PushNotificationConfigCopyWithImpl<PushNotificationConfig>(
        this as PushNotificationConfig,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.enablePush, enablePush) || other.enablePush == enablePush) &&
  ...
  int get hashCode => Object.hash(
    runtimeType,
    enablePush,
    const DeepCollectionEquality().hash(pushTypes),
  );
...
abstract mixin class $PushNotificationConfigCopyWith<$Res> {
  factory $PushNotificationConfigCopyWith(
    PushNotificationConfig value,
...
/// @nodoc
class _$PushNotificationConfigCopyWithImpl<$Res> implements $PushNotificationConfigCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? enablePush = freezed, Object? pushTypes = freezed}) {
    return _then(
