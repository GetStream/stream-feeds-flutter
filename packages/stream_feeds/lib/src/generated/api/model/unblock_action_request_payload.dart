...
part 'unblock_action_request_payload.g.dart';
part 'unblock_action_request_payload.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class UnblockActionRequestPayload with _$UnblockActionRequestPayload {
  const UnblockActionRequestPayload({
    this.decisionReason,
  });
