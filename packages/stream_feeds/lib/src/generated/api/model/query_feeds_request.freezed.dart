...
mixin _$QueryFeedsRequest {
 ...
 bool? get enrichOwnFields; Map<String, Object?>? get filter; int? get limit; String? get next; String? get prev; List<SortParamRequest>? get sort; bool? get watch;
/// Create a copy of QueryFeedsRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$QueryFeedsRequestCopyWith<QueryFeedsRequest> get copyWith => _$QueryFeedsRequestCopyWithImpl<QueryFeedsRequest>(this as QueryFeedsRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryFeedsRequest&&(identical(other.enrichOwnFields, enrichOwnFields) || other.enrichOwnFields == enrichOwnFields)&&const DeepCollectionEquality().equals(other.filter, filter)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.next, next) || other.next == next)&&(identical(other.prev, prev) || other.prev == prev)&&const DeepCollectionEquality().equals(other.sort, sort)&&(identical(other.watch, watch) || other.watch == watch));
}


@override
int get hashCode => Object.hash(runtimeType,enrichOwnFields,const DeepCollectionEquality().hash(filter),limit,next,prev,const DeepCollectionEquality().hash(sort),watch);
...
abstract mixin class $QueryFeedsRequestCopyWith<$Res>  {
  factory $QueryFeedsRequestCopyWith(QueryFeedsRequest value, $Res Function(QueryFeedsRequest) _then) = _$QueryFeedsRequestCopyWithImpl;
@useResult
$Res call({
 bool? enrichOwnFields, Map<String, Object?>? filter, int? limit, String? next, String? prev, List<SortParamRequest>? sort, bool? watch
});
...
/// Create a copy of QueryFeedsRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enrichOwnFields = freezed,Object? filter = freezed,Object? limit = freezed,Object? next = freezed,Object? prev = freezed,Object? sort = freezed,Object? watch = freezed,}) {
...
as List<SortParamRequest>?,watch: freezed == watch ? _self.watch : watch // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
