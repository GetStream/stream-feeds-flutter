...
$UserRuleParametersCopyWith<UserRuleParameters> get copyWith => _$UserRuleParametersCopyWithImpl<UserRuleParameters>(this as UserRuleParameters, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserRuleParameters&&(identical(other.maxAge, maxAge) || other.maxAge == maxAge));
}
...
abstract mixin class $UserRuleParametersCopyWith<$Res>  {
  factory $UserRuleParametersCopyWith(UserRuleParameters value, $Res Function(UserRuleParameters) _then) = _$UserRuleParametersCopyWithImpl;
@useResult
$Res call({
 String? maxAge
});
