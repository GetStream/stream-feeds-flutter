...
mixin _$Action {
 ...
 String get name; String? get style; String get text; String get type; String? get value;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Action&&(identical(other.name, name) || other.name == name)&&(identical(other.style, style) || other.style == style)&&(identical(other.text, text) || other.text == text)&&(identical(other.type, type) || other.type == type)&&(identical(other.value, value) || other.value == value));
}
...
@useResult
$Res call({
 String name, String? style, String text, String type, String? value
});
...
/// Create a copy of Action
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? style = freezed,Object? text = null,Object? type = null,Object? value = freezed,}) {
  return _then(Action(
