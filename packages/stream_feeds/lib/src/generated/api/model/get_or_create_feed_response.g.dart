...
GetOrCreateFeedResponse _$GetOrCreateFeedResponseFromJson(Map<String, dynamic> json) => GetOrCreateFeedResponse(
  ...
  aggregatedActivities: (json['aggregated_activities'] as List<dynamic>)
      .map((e) => AggregatedActivityResponse.fromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  followersPagination: json['followers_pagination'] == null
      ? null
      : PagerResponse.fromJson(json['followers_pagination'] as Map<String, dynamic>),
  following: (json['following'] as List<dynamic>)
      .map((e) => FollowResponse.fromJson(e as Map<String, dynamic>))
      .toList(),
  followingPagination: json['following_pagination'] == null
      ? null
      : PagerResponse.fromJson(json['following_pagination'] as Map<String, dynamic>),
  memberPagination: json['member_pagination'] == null
      ? null
      : PagerResponse.fromJson(json['member_pagination'] as Map<String, dynamic>),
  ...
  notificationStatus: json['notification_status'] == null
      ? null
      : NotificationStatusResponse.fromJson(json['notification_status'] as Map<String, dynamic>),
...
Map<String, dynamic> _$GetOrCreateFeedResponseToJson(GetOrCreateFeedResponse instance) => <String, dynamic>{
  'activities': instance.activities.map((e) => e.toJson()).toList(),
  'aggregated_activities': instance.aggregatedActivities.map((e) => e.toJson()).toList(),
