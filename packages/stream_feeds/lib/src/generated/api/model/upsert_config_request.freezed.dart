...
abstract mixin class $UpsertConfigRequestCopyWith<$Res>  {
  factory $UpsertConfigRequestCopyWith(UpsertConfigRequest value, $Res Function(UpsertConfigRequest) _then) = _$UpsertConfigRequestCopyWithImpl;
@useResult
$Res call({
 AIImageConfig? aiImageConfig, AITextConfig? aiTextConfig, AIVideoConfig? aiVideoConfig, bool? async, AutomodPlatformCircumventionConfig? automodPlatformCircumventionConfig, AutomodSemanticFiltersConfig? automodSemanticFiltersConfig, AutomodToxicityConfig? automodToxicityConfig, AIImageConfig? awsRekognitionConfig, BlockListConfig? blockListConfig, AITextConfig? bodyguardConfig, FloodConfig? floodConfig, GoogleVisionConfig? googleVisionConfig, String key, LLMConfig? llmConfig, RuleBuilderConfig? ruleBuilderConfig, String? team, VelocityFilterConfig? velocityFilterConfig, VideoCallRuleConfig? videoCallRuleConfig
});
...
/// Create a copy of UpsertConfigRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? aiImageConfig = freezed,Object? aiTextConfig = freezed,Object? aiVideoConfig = freezed,Object? async = freezed,Object? automodPlatformCircumventionConfig = freezed,Object? automodSemanticFiltersConfig = freezed,Object? automodToxicityConfig = freezed,Object? awsRekognitionConfig = freezed,Object? blockListConfig = freezed,Object? bodyguardConfig = freezed,Object? floodConfig = freezed,Object? googleVisionConfig = freezed,Object? key = null,Object? llmConfig = freezed,Object? ruleBuilderConfig = freezed,Object? team = freezed,Object? velocityFilterConfig = freezed,Object? videoCallRuleConfig = freezed,}) {
...
as AutomodToxicityConfig?,awsRekognitionConfig: freezed == awsRekognitionConfig ? _self.awsRekognitionConfig : awsRekognitionConfig // ignore: cast_nullable_to_non_nullable
...
as AITextConfig?,floodConfig: freezed == floodConfig ? _self.floodConfig : floodConfig // ignore: cast_nullable_to_non_nullable
as FloodConfig?,googleVisionConfig: freezed == googleVisionConfig ? _self.googleVisionConfig : googleVisionConfig // ignore: cast_nullable_to_non_nullable
...
as LLMConfig?,ruleBuilderConfig: freezed == ruleBuilderConfig ? _self.ruleBuilderConfig : ruleBuilderConfig // ignore: cast_nullable_to_non_nullable
as RuleBuilderConfig?,team: freezed == team ? _self.team : team // ignore: cast_nullable_to_non_nullable
as String?,velocityFilterConfig: freezed == velocityFilterConfig ? _self.velocityFilterConfig : velocityFilterConfig // ignore: cast_nullable_to_non_nullable
