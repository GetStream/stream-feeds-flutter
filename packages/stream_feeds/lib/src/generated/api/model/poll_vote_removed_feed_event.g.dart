...
PollVoteRemovedFeedEvent _$PollVoteRemovedFeedEventFromJson(Map<String, dynamic> json) => PollVoteRemovedFeedEvent(
  ...
  pollVote: PollVoteResponseData.fromJson(json['poll_vote'] as Map<String, dynamic>),
  receivedAt: _$JsonConverterFromJson<int, DateTime>(json['received_at'], const EpochDateTimeConverter().fromJson),
  type: json['type'] as String,
);

Map<String, dynamic> _$PollVoteRemovedFeedEventToJson(PollVoteRemovedFeedEvent instance) => <String, dynamic>{
