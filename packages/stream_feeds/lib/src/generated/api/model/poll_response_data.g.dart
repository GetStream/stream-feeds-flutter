...
class PollResponseData {
  ...
  static PollResponseData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PollResponseData(
        ...
        latestAnswers:
            PollVoteResponseData.listFromJson(json[r'latest_answers']),
        latestVotesByOption: mapCastOfType<String, List<PollVoteResponseData>>(
            json, r'latest_votes_by_option')!,
        maxVotesAllowed: mapValueOfType<int>(json, r'max_votes_allowed', null),
        name: mapValueOfType<String>(json, r'name')!,
        options: PollOptionResponseData.listFromJson(json[r'options']),
        ownVotes: PollVoteResponseData.listFromJson(json[r'own_votes']),
  ...
  static List<PollResponseData> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <PollResponseData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PollResponseData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is PollResponseData &&
