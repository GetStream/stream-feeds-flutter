...
mixin _$CollectionResponse {
 ...
 DateTime? get createdAt; Map<String, Object?>? get custom; String get id; String get name; DateTime? get updatedAt; String? get userId;
...
@override
int get hashCode => Object.hash(runtimeType,createdAt,const DeepCollectionEquality().hash(custom),id,name,updatedAt,userId);
...
@useResult
$Res call({
 DateTime? createdAt, Map<String, Object?>? custom, String id, String name, DateTime? updatedAt, String? userId
});
...
/// Create a copy of CollectionResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = freezed,Object? custom = freezed,Object? id = null,Object? name = null,Object? updatedAt = freezed,Object? userId = freezed,}) {
