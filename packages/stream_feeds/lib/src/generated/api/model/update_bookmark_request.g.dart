...
UpdateBookmarkRequest _$UpdateBookmarkRequestFromJson(Map<String, dynamic> json) => UpdateBookmarkRequest(
...
Map<String, dynamic> _$UpdateBookmarkRequestToJson(UpdateBookmarkRequest instance) => <String, dynamic>{
