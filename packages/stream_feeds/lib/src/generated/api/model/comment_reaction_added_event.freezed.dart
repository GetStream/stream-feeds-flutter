...
mixin _$CommentReactionAddedEvent {
 ...
 ActivityResponse get activity; CommentResponse get comment; DateTime get createdAt; Map<String, Object?> get custom; String? get feedVisibility; String get fid; FeedsReactionResponse get reaction; DateTime? get receivedAt; String get type; UserResponseCommonFields? get user;
/// Create a copy of CommentReactionAddedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CommentReactionAddedEventCopyWith<CommentReactionAddedEvent> get copyWith => _$CommentReactionAddedEventCopyWithImpl<CommentReactionAddedEvent>(this as CommentReactionAddedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentReactionAddedEvent&&(identical(other.activity, activity) || other.activity == activity)&&(identical(other.comment, comment) || other.comment == comment)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.feedVisibility, feedVisibility) || other.feedVisibility == feedVisibility)&&(identical(other.fid, fid) || other.fid == fid)&&(identical(other.reaction, reaction) || other.reaction == reaction)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt)&&(identical(other.type, type) || other.type == type)&&(identical(other.user, user) || other.user == user));
}


@override
int get hashCode => Object.hash(runtimeType,activity,comment,createdAt,const DeepCollectionEquality().hash(custom),feedVisibility,fid,reaction,receivedAt,type,user);

@override
String toString() {
  return 'CommentReactionAddedEvent(activity: $activity, comment: $comment, createdAt: $createdAt, custom: $custom, feedVisibility: $feedVisibility, fid: $fid, reaction: $reaction, receivedAt: $receivedAt, type: $type, user: $user)';
}
...
abstract mixin class $CommentReactionAddedEventCopyWith<$Res>  {
  factory $CommentReactionAddedEventCopyWith(CommentReactionAddedEvent value, $Res Function(CommentReactionAddedEvent) _then) = _$CommentReactionAddedEventCopyWithImpl;
@useResult
$Res call({
 ActivityResponse activity, CommentResponse comment, DateTime createdAt, Map<String, Object?> custom, String? feedVisibility, String fid, FeedsReactionResponse reaction, DateTime? receivedAt, String type, UserResponseCommonFields? user
});
...
/// Create a copy of CommentReactionAddedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activity = null,Object? comment = null,Object? createdAt = null,Object? custom = null,Object? feedVisibility = freezed,Object? fid = null,Object? reaction = null,Object? receivedAt = freezed,Object? type = null,Object? user = freezed,}) {
