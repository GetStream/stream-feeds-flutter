...
part 'ingress_video_encoding_options.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class IngressVideoEncodingOptions with _$IngressVideoEncodingOptions {
  const IngressVideoEncodingOptions({
  ...
  static IngressVideoEncodingOptions fromJson(Map<String, dynamic> json) =>
