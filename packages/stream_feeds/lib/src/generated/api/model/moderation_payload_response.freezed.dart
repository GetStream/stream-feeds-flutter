...
$ModerationPayloadResponseCopyWith<ModerationPayloadResponse> get copyWith => _$ModerationPayloadResponseCopyWithImpl<ModerationPayloadResponse>(this as ModerationPayloadResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModerationPayloadResponse&&const DeepCollectionEquality().equals(other.custom, custom)&&const DeepCollectionEquality().equals(other.images, images)&&const DeepCollectionEquality().equals(other.texts, texts)&&const DeepCollectionEquality().equals(other.videos, videos));
}
...
abstract mixin class $ModerationPayloadResponseCopyWith<$Res>  {
  factory $ModerationPayloadResponseCopyWith(ModerationPayloadResponse value, $Res Function(ModerationPayloadResponse) _then) = _$ModerationPayloadResponseCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? custom = freezed,Object? images = freezed,Object? texts = freezed,Object? videos = freezed,}) {
  return _then(ModerationPayloadResponse(
