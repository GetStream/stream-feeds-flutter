...
UserReactivatedEvent _$UserReactivatedEventFromJson(Map<String, dynamic> json) => UserReactivatedEvent(
...
Map<String, dynamic> _$UserReactivatedEventToJson(UserReactivatedEvent instance) => <String, dynamic>{
