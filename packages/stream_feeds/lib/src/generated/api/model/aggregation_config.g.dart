...
AggregationConfig _$AggregationConfigFromJson(Map<String, dynamic> json) => AggregationConfig(
...
Map<String, dynamic> _$AggregationConfigToJson(AggregationConfig instance) => <String, dynamic>{
