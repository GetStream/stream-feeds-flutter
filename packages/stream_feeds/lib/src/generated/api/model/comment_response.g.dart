...
CommentResponse _$CommentResponseFromJson(Map<String, dynamic> json) => CommentResponse(
  ...
  status: $enumDecode(_$CommentResponseStatusEnumMap, json['status'], unknownValue: CommentResponseStatus.unknown),
...
Map<String, dynamic> _$CommentResponseToJson(CommentResponse instance) => <String, dynamic>{
