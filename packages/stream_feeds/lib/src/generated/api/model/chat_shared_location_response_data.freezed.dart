...
mixin _$ChatSharedLocationResponseData {
 ...
 String get channelCid; DateTime get createdAt; String get createdByDeviceId; DateTime? get endAt; double get latitude; double get longitude; ChatMessageResponse? get message; String get messageId; DateTime get updatedAt; String get userId;
/// Create a copy of ChatSharedLocationResponseData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ChatSharedLocationResponseDataCopyWith<ChatSharedLocationResponseData> get copyWith => _$ChatSharedLocationResponseDataCopyWithImpl<ChatSharedLocationResponseData>(this as ChatSharedLocationResponseData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatSharedLocationResponseData&&(identical(other.channelCid, channelCid) || other.channelCid == channelCid)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdByDeviceId, createdByDeviceId) || other.createdByDeviceId == createdByDeviceId)&&(identical(other.endAt, endAt) || other.endAt == endAt)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.message, message) || other.message == message)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.userId, userId) || other.userId == userId));
}


@override
int get hashCode => Object.hash(runtimeType,channelCid,createdAt,createdByDeviceId,endAt,latitude,longitude,message,messageId,updatedAt,userId);
...
abstract mixin class $ChatSharedLocationResponseDataCopyWith<$Res>  {
  factory $ChatSharedLocationResponseDataCopyWith(ChatSharedLocationResponseData value, $Res Function(ChatSharedLocationResponseData) _then) = _$ChatSharedLocationResponseDataCopyWithImpl;
@useResult
$Res call({
 String channelCid, DateTime createdAt, String createdByDeviceId, DateTime? endAt, double latitude, double longitude, ChatMessageResponse? message, String messageId, DateTime updatedAt, String userId
});
...
/// Create a copy of ChatSharedLocationResponseData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? channelCid = null,Object? createdAt = null,Object? createdByDeviceId = null,Object? endAt = freezed,Object? latitude = null,Object? longitude = null,Object? message = freezed,Object? messageId = null,Object? updatedAt = null,Object? userId = null,}) {
  return _then(ChatSharedLocationResponseData(
