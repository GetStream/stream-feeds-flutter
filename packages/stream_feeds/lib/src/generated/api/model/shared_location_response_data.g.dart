...
class SharedLocationResponseData {
  ...
  static SharedLocationResponseData? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SharedLocationResponseData> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <SharedLocationResponseData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SharedLocationResponseData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
