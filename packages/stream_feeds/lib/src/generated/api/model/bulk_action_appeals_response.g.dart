...
BulkActionAppealsResponse _$BulkActionAppealsResponseFromJson(
  ...
  errors:
      (json['errors'] as List<dynamic>?)?.map((e) => BulkAppealError.fromJson(e as Map<String, dynamic>)).toList() ??
      [],
  results:
      (json['results'] as List<dynamic>?)?.map((e) => BulkAppealResult.fromJson(e as Map<String, dynamic>)).toList() ??
      [],
);
