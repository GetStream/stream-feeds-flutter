...
BulkActionAppealsResponse _$BulkActionAppealsResponseFromJson(Map<String, dynamic> json) => BulkActionAppealsResponse(
...
Map<String, dynamic> _$BulkActionAppealsResponseToJson(BulkActionAppealsResponse instance) => <String, dynamic>{
