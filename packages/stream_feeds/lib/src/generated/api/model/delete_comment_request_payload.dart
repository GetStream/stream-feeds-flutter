...
part 'delete_comment_request_payload.g.dart';
part 'delete_comment_request_payload.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class DeleteCommentRequestPayload with _$DeleteCommentRequestPayload {
  const DeleteCommentRequestPayload({
    this.entityId,
    this.entityType,
    this.hardDelete,
    this.reason,
