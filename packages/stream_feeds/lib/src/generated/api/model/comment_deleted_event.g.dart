...
class CommentDeletedEvent {
  ...
  static CommentDeletedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CommentDeletedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.comment.deleted")!,
  ...
  static List<CommentDeletedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <CommentDeletedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentDeletedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
