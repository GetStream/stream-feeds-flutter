...
CommentDeletedEvent _$CommentDeletedEventFromJson(Map<String, dynamic> json) => CommentDeletedEvent(
...
Map<String, dynamic> _$CommentDeletedEventToJson(CommentDeletedEvent instance) => <String, dynamic>{
