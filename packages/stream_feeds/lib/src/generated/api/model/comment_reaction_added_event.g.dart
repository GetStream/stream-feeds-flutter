...
CommentReactionAddedEvent _$CommentReactionAddedEventFromJson(Map<String, dynamic> json) => CommentReactionAddedEvent(
...
Map<String, dynamic> _$CommentReactionAddedEventToJson(CommentReactionAddedEvent instance) => <String, dynamic>{
