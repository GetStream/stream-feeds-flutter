...
$AddCommentBookmarkResponseCopyWith<AddCommentBookmarkResponse> get copyWith => _$AddCommentBookmarkResponseCopyWithImpl<AddCommentBookmarkResponse>(this as AddCommentBookmarkResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddCommentBookmarkResponse&&(identical(other.bookmark, bookmark) || other.bookmark == bookmark)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $AddCommentBookmarkResponseCopyWith<$Res>  {
  factory $AddCommentBookmarkResponseCopyWith(AddCommentBookmarkResponse value, $Res Function(AddCommentBookmarkResponse) _then) = _$AddCommentBookmarkResponseCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AddCommentBookmarkResponseCopyWithImpl<$Res>
    implements $AddCommentBookmarkResponseCopyWith<$Res> {
...
@pragma('vm:prefer-inline') @override $Res call({Object? bookmark = null,Object? duration = null,}) {
  return _then(AddCommentBookmarkResponse(
