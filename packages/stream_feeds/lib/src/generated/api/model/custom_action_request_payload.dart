...
part 'custom_action_request_payload.g.dart';
part 'custom_action_request_payload.freezed.dart';

@freezed
@immutable
@JsonSerializable()
class CustomActionRequestPayload with _$CustomActionRequestPayload {
  const CustomActionRequestPayload({
    this.id,
    this.options,
  });
