...
AppealItemResponse _$AppealItemResponseFromJson(Map<String, dynamic> json) => AppealItemResponse(
  ...
  entityContent: json['entity_content'] == null
      ? null
      : ModerationPayload.fromJson(json['entity_content'] as Map<String, dynamic>),
  entityId: json['entity_id'] as String,
  entityType: json['entity_type'] as String,
  flagLabels: (json['flag_labels'] as List<dynamic>?)?.map((e) => e as String).toList(),
  flagTypes: (json['flag_types'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ...
  moderationAction: json['moderation_action'] == null
      ? null
      : ActionLogResponse.fromJson(json['moderation_action'] as Map<String, dynamic>),
  originalModerationAction: json['original_moderation_action'] == null
      ? null
      : ActionLogResponse.fromJson(json['original_moderation_action'] as Map<String, dynamic>),
...
Map<String, dynamic> _$AppealItemResponseToJson(AppealItemResponse instance) => <String, dynamic>{
