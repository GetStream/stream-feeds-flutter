...
CommentAddedEvent _$CommentAddedEventFromJson(Map<String, dynamic> json) => CommentAddedEvent(
...
Map<String, dynamic> _$CommentAddedEventToJson(CommentAddedEvent instance) => <String, dynamic>{
