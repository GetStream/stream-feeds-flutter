...
mixin _$ChatReminderResponseData {
  ...
  $ChatReminderResponseDataCopyWith<ChatReminderResponseData> get copyWith =>
      _$ChatReminderResponseDataCopyWithImpl<ChatReminderResponseData>(
          this as ChatReminderResponseData, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, channelCid, createdAt, message,
      messageId, remindAt, updatedAt, user, userId);
...
abstract mixin class $ChatReminderResponseDataCopyWith<$Res> {
  factory $ChatReminderResponseDataCopyWith(ChatReminderResponseData value,
