...
PushPreferencesResponse _$PushPreferencesResponseFromJson(Map<String, dynamic> json) => PushPreferencesResponse(
  ...
  feedsPreferences: json['feeds_preferences'] == null
      ? null
      : FeedsPreferencesResponse.fromJson(json['feeds_preferences'] as Map<String, dynamic>),
);

Map<String, dynamic> _$PushPreferencesResponseToJson(PushPreferencesResponse instance) => <String, dynamic>{
