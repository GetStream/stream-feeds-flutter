...
class AddReactionResponse {
  ...
  static AddReactionResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AddReactionResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <AddReactionResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AddReactionResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
