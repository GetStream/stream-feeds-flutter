...
mixin _$PollVoteResponse {
 ...
 String get duration; PollResponseData? get poll; PollVoteResponseData? get vote;
/// Create a copy of PollVoteResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PollVoteResponseCopyWith<PollVoteResponse> get copyWith => _$PollVoteResponseCopyWithImpl<PollVoteResponse>(this as PollVoteResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PollVoteResponse&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.poll, poll) || other.poll == poll)&&(identical(other.vote, vote) || other.vote == vote));
}
...
abstract mixin class $PollVoteResponseCopyWith<$Res>  {
  factory $PollVoteResponseCopyWith(PollVoteResponse value, $Res Function(PollVoteResponse) _then) = _$PollVoteResponseCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of PollVoteResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? duration = null,Object? poll = freezed,Object? vote = freezed,}) {
