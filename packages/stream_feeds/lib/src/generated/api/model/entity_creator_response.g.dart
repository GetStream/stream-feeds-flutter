...
EntityCreatorResponse _$EntityCreatorResponseFromJson(Map<String, dynamic> json) => EntityCreatorResponse(
...
Map<String, dynamic> _$EntityCreatorResponseToJson(EntityCreatorResponse instance) => <String, dynamic>{
