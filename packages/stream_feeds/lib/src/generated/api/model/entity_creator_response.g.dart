...
class EntityCreatorResponse {
  ...
  static EntityCreatorResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return EntityCreatorResponse(
        ...
        flaggedCount: mapValueOfType<int>(json, r'flagged_count')!,
  ...
  static List<EntityCreatorResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <EntityCreatorResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EntityCreatorResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is EntityCreatorResponse &&
