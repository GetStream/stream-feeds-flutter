...
ActivityPinResponse _$ActivityPinResponseFromJson(Map<String, dynamic> json) => ActivityPinResponse(
...
Map<String, dynamic> _$ActivityPinResponseToJson(ActivityPinResponse instance) => <String, dynamic>{
