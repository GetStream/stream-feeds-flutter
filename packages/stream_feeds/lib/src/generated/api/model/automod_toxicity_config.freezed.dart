...
$AutomodToxicityConfigCopyWith<AutomodToxicityConfig> get copyWith => _$AutomodToxicityConfigCopyWithImpl<AutomodToxicityConfig>(this as AutomodToxicityConfig, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AutomodToxicityConfig&&(identical(other.async, async) || other.async == async)&&(identical(other.enabled, enabled) || other.enabled == enabled)&&const DeepCollectionEquality().equals(other.rules, rules));
}
...
abstract mixin class $AutomodToxicityConfigCopyWith<$Res>  {
  factory $AutomodToxicityConfigCopyWith(AutomodToxicityConfig value, $Res Function(AutomodToxicityConfig) _then) = _$AutomodToxicityConfigCopyWithImpl;
@useResult
$Res call({
