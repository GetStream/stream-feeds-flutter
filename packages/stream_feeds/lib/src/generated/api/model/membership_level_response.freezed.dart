...
mixin _$MembershipLevelResponse {
 ...
 DateTime get createdAt; Map<String, Object?>? get custom; String? get description; String get id; String get name; int get priority; List<String> get tags; DateTime get updatedAt;
/// Create a copy of MembershipLevelResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MembershipLevelResponseCopyWith<MembershipLevelResponse> get copyWith => _$MembershipLevelResponseCopyWithImpl<MembershipLevelResponse>(this as MembershipLevelResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MembershipLevelResponse&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.custom, custom)&&(identical(other.description, description) || other.description == description)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.priority, priority) || other.priority == priority)&&const DeepCollectionEquality().equals(other.tags, tags)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}


@override
int get hashCode => Object.hash(runtimeType,createdAt,const DeepCollectionEquality().hash(custom),description,id,name,priority,const DeepCollectionEquality().hash(tags),updatedAt);
...
abstract mixin class $MembershipLevelResponseCopyWith<$Res>  {
  factory $MembershipLevelResponseCopyWith(MembershipLevelResponse value, $Res Function(MembershipLevelResponse) _then) = _$MembershipLevelResponseCopyWithImpl;
@useResult
$Res call({
 DateTime createdAt, Map<String, Object?>? custom, String? description, String id, String name, int priority, List<String> tags, DateTime updatedAt
});
...
/// Create a copy of MembershipLevelResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? custom = freezed,Object? description = freezed,Object? id = null,Object? name = null,Object? priority = null,Object? tags = null,Object? updatedAt = null,}) {
