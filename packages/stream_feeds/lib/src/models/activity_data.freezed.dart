...
mixin _$ActivityData {
 ...
 List<Attachment> get attachments; int get bookmarkCount; Map<String, CollectionData> get collections; int get commentCount; List<CommentData> get comments; DateTime get createdAt; FeedData? get currentFeed; DateTime? get deletedAt; DateTime? get editedAt; DateTime? get expiresAt; List<String> get feeds; List<String> get filterTags; int? get friendReactionCount; List<FeedsReactionData> get friendReactions; String get id; List<String> get interestTags; bool? get isRead; bool? get isSeen; bool? get isWatched; List<FeedsReactionData> get latestReactions; LocationCoordinate? get location; List<UserData> get mentionedUsers; Map<String, int> get metrics; Moderation? get moderation; NotificationContext? get notificationContext; List<BookmarkData> get ownBookmarks; List<FeedsReactionData> get ownReactions; ActivityData? get parent; PollData? get poll; int get popularity; bool get hidden; bool get preview; int get reactionCount; Map<String, ReactionGroupData> get reactionGroups; double get score; Map<String, Object?> get searchData; int get shareCount; String? get text; String get type; DateTime get updatedAt; UserData get user; ActivityDataVisibility get visibility; String? get visibilityTag; Map<String, Object?>? get custom;
...
@useResult
$Res call({
 List<Attachment> attachments, int bookmarkCount, Map<String, CollectionData> collections, int commentCount, List<CommentData> comments, DateTime createdAt, FeedData? currentFeed, DateTime? deletedAt, DateTime? editedAt, DateTime? expiresAt, List<String> feeds, List<String> filterTags, int? friendReactionCount, List<FeedsReactionData> friendReactions, String id, List<String> interestTags, bool? isRead, bool? isSeen, bool? isWatched, List<FeedsReactionData> latestReactions, LocationCoordinate? location, List<UserData> mentionedUsers, Map<String, int> metrics, Moderation? moderation, NotificationContext? notificationContext, List<BookmarkData> ownBookmarks, List<FeedsReactionData> ownReactions, ActivityData? parent, PollData? poll, int popularity, bool hidden, bool preview, int reactionCount, Map<String, ReactionGroupData> reactionGroups, double score, Map<String, Object?> searchData, int shareCount, String? text, String type, DateTime updatedAt, UserData user, ActivityDataVisibility visibility, String? visibilityTag, Map<String, Object?>? custom
});
...
/// Create a copy of ActivityData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? attachments = null,Object? bookmarkCount = null,Object? collections = null,Object? commentCount = null,Object? comments = null,Object? createdAt = null,Object? currentFeed = freezed,Object? deletedAt = freezed,Object? editedAt = freezed,Object? expiresAt = freezed,Object? feeds = null,Object? filterTags = null,Object? friendReactionCount = freezed,Object? friendReactions = null,Object? id = null,Object? interestTags = null,Object? isRead = freezed,Object? isSeen = freezed,Object? isWatched = freezed,Object? latestReactions = null,Object? location = freezed,Object? mentionedUsers = null,Object? metrics = null,Object? moderation = freezed,Object? notificationContext = freezed,Object? ownBookmarks = null,Object? ownReactions = null,Object? parent = freezed,Object? poll = freezed,Object? popularity = null,Object? hidden = null,Object? preview = null,Object? reactionCount = null,Object? reactionGroups = null,Object? score = null,Object? searchData = null,Object? shareCount = null,Object? text = freezed,Object? type = null,Object? updatedAt = null,Object? user = null,Object? visibility = null,Object? visibilityTag = freezed,Object? custom = freezed,}) {
...
as Map<String, CollectionData>,commentCount: null == commentCount ? _self.commentCount : commentCount // ignore: cast_nullable_to_non_nullable
as int,comments: null == comments ? _self.comments : comments // ignore: cast_nullable_to_non_nullable
as List<CommentData>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,currentFeed: freezed == currentFeed ? _self.currentFeed : currentFeed // ignore: cast_nullable_to_non_nullable
as FeedData?,deletedAt: freezed == deletedAt ? _self.deletedAt : deletedAt // ignore: cast_nullable_to_non_nullable
...
as int?,friendReactions: null == friendReactions ? _self.friendReactions : friendReactions // ignore: cast_nullable_to_non_nullable
as List<FeedsReactionData>,id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as List<FeedsReactionData>,location: freezed == location ? _self.location : location // ignore: cast_nullable_to_non_nullable
as LocationCoordinate?,mentionedUsers: null == mentionedUsers ? _self.mentionedUsers : mentionedUsers // ignore: cast_nullable_to_non_nullable
as List<UserData>,metrics: null == metrics ? _self.metrics : metrics // ignore: cast_nullable_to_non_nullable
as Map<String, int>,moderation: freezed == moderation ? _self.moderation : moderation // ignore: cast_nullable_to_non_nullable
as Moderation?,notificationContext: freezed == notificationContext ? _self.notificationContext : notificationContext // ignore: cast_nullable_to_non_nullable
as NotificationContext?,ownBookmarks: null == ownBookmarks ? _self.ownBookmarks : ownBookmarks // ignore: cast_nullable_to_non_nullable
as List<BookmarkData>,ownReactions: null == ownReactions ? _self.ownReactions : ownReactions // ignore: cast_nullable_to_non_nullable
as List<FeedsReactionData>,parent: freezed == parent ? _self.parent : parent // ignore: cast_nullable_to_non_nullable
as ActivityData?,poll: freezed == poll ? _self.poll : poll // ignore: cast_nullable_to_non_nullable
as PollData?,popularity: null == popularity ? _self.popularity : popularity // ignore: cast_nullable_to_non_nullable
...
as Map<String, ReactionGroupData>,score: null == score ? _self.score : score // ignore: cast_nullable_to_non_nullable
as double,searchData: null == searchData ? _self.searchData : searchData // ignore: cast_nullable_to_non_nullable
as Map<String, Object?>,shareCount: null == shareCount ? _self.shareCount : shareCount // ignore: cast_nullable_to_non_nullable
...
as UserData,visibility: null == visibility ? _self.visibility : visibility // ignore: cast_nullable_to_non_nullable
