...
mixin _$FeedId {
 ...
 String get group; String get id; String get rawValue;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedId&&(identical(other.group, group) || other.group == group)&&(identical(other.id, id) || other.id == id)&&(identical(other.rawValue, rawValue) || other.rawValue == rawValue));
}
...
/// @nodoc
class _$FeedIdCopyWithImpl<$Res>
...
/// Create a copy of FeedId
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? group = null,Object? id = null,}) {
  return _then(FeedId(
