...
mixin _$ModerationConfigData {
 ...
 AIImageConfig? get aiImageConfig; AITextConfig? get aiTextConfig; AIVideoConfig? get aiVideoConfig; bool get async; AutomodPlatformCircumventionConfig? get automodPlatformCircumventionConfig; AutomodSemanticFiltersConfig? get automodSemanticFiltersConfig; AutomodToxicityConfig? get automodToxicityConfig; BlockListConfig? get blockListConfig; DateTime get createdAt; String get key; String get team; DateTime get updatedAt; VelocityFilterConfig? get velocityFilterConfig;
/// Create a copy of ModerationConfigData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ModerationConfigDataCopyWith<ModerationConfigData> get copyWith => _$ModerationConfigDataCopyWithImpl<ModerationConfigData>(this as ModerationConfigData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModerationConfigData&&(identical(other.aiImageConfig, aiImageConfig) || other.aiImageConfig == aiImageConfig)&&(identical(other.aiTextConfig, aiTextConfig) || other.aiTextConfig == aiTextConfig)&&(identical(other.aiVideoConfig, aiVideoConfig) || other.aiVideoConfig == aiVideoConfig)&&(identical(other.async, async) || other.async == async)&&(identical(other.automodPlatformCircumventionConfig, automodPlatformCircumventionConfig) || other.automodPlatformCircumventionConfig == automodPlatformCircumventionConfig)&&(identical(other.automodSemanticFiltersConfig, automodSemanticFiltersConfig) || other.automodSemanticFiltersConfig == automodSemanticFiltersConfig)&&(identical(other.automodToxicityConfig, automodToxicityConfig) || other.automodToxicityConfig == automodToxicityConfig)&&(identical(other.blockListConfig, blockListConfig) || other.blockListConfig == blockListConfig)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.key, key) || other.key == key)&&(identical(other.team, team) || other.team == team)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.velocityFilterConfig, velocityFilterConfig) || other.velocityFilterConfig == velocityFilterConfig));
}


@override
int get hashCode => Object.hash(runtimeType,aiImageConfig,aiTextConfig,aiVideoConfig,async,automodPlatformCircumventionConfig,automodSemanticFiltersConfig,automodToxicityConfig,blockListConfig,createdAt,key,team,updatedAt,velocityFilterConfig);
...
abstract mixin class $ModerationConfigDataCopyWith<$Res>  {
  factory $ModerationConfigDataCopyWith(ModerationConfigData value, $Res Function(ModerationConfigData) _then) = _$ModerationConfigDataCopyWithImpl;
@useResult
$Res call({
 AIImageConfig? aiImageConfig, AITextConfig? aiTextConfig, AIVideoConfig? aiVideoConfig, bool async, AutomodPlatformCircumventionConfig? automodPlatformCircumventionConfig, AutomodSemanticFiltersConfig? automodSemanticFiltersConfig, AutomodToxicityConfig? automodToxicityConfig, BlockListConfig? blockListConfig, DateTime createdAt, String key, String team, DateTime updatedAt, VelocityFilterConfig? velocityFilterConfig
});
