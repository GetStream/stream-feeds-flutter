...
$ReactionGroupDataCopyWith<ReactionGroupData> get copyWith => _$ReactionGroupDataCopyWithImpl<ReactionGroupData>(this as ReactionGroupData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReactionGroupData&&(identical(other.count, count) || other.count == count)&&(identical(other.firstReactionAt, firstReactionAt) || other.firstReactionAt == firstReactionAt)&&(identical(other.lastReactionAt, lastReactionAt) || other.lastReactionAt == lastReactionAt));
}
...
abstract mixin class $ReactionGroupDataCopyWith<$Res>  {
  factory $ReactionGroupDataCopyWith(ReactionGroupData value, $Res Function(ReactionGroupData) _then) = _$ReactionGroupDataCopyWithImpl;
@useResult
$Res call({
