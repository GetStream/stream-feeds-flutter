...
mixin _$BookmarkData {
 ...
 ActivityData get activity; DateTime get createdAt; BookmarkFolderData? get folder; DateTime get updatedAt; UserData get user; Map<String, Object?>? get custom;
...
@override
int get hashCode => Object.hash(runtimeType,activity,createdAt,folder,updatedAt,user,const DeepCollectionEquality().hash(custom));
...
@useResult
$Res call({
 ActivityData activity, DateTime createdAt, BookmarkFolderData? folder, DateTime updatedAt, UserData user, Map<String, Object?>? custom
});
...
/// Create a copy of BookmarkData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activity = null,Object? createdAt = null,Object? folder = freezed,Object? updatedAt = null,Object? user = null,Object? custom = freezed,}) {
