...
$FileUploadConfigDataCopyWith<FileUploadConfigData> get copyWith => _$FileUploadConfigDataCopyWithImpl<FileUploadConfigData>(this as FileUploadConfigData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FileUploadConfigData&&const DeepCollectionEquality().equals(other.allowedFileExtensions, allowedFileExtensions)&&const DeepCollectionEquality().equals(other.allowedMimeTypes, allowedMimeTypes)&&const DeepCollectionEquality().equals(other.blockedFileExtensions, blockedFileExtensions)&&const DeepCollectionEquality().equals(other.blockedMimeTypes, blockedMimeTypes)&&(identical(other.sizeLimit, sizeLimit) || other.sizeLimit == sizeLimit));
}
...
abstract mixin class $FileUploadConfigDataCopyWith<$Res>  {
  factory $FileUploadConfigDataCopyWith(FileUploadConfigData value, $Res Function(FileUploadConfigData) _then) = _$FileUploadConfigDataCopyWithImpl;
@useResult
$Res call({
