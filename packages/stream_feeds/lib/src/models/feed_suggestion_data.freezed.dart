...
mixin _$FeedSuggestionData {
 ...
 FeedData get feed; Map<String, double>? get algorithmScores; String? get reason; double? get recommendationScore;
/// Create a copy of FeedSuggestionData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeedSuggestionDataCopyWith<FeedSuggestionData> get copyWith => _$FeedSuggestionDataCopyWithImpl<FeedSuggestionData>(this as FeedSuggestionData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedSuggestionData&&(identical(other.feed, feed) || other.feed == feed)&&const DeepCollectionEquality().equals(other.algorithmScores, algorithmScores)&&(identical(other.reason, reason) || other.reason == reason)&&(identical(other.recommendationScore, recommendationScore) || other.recommendationScore == recommendationScore));
}


@override
int get hashCode => Object.hash(runtimeType,feed,const DeepCollectionEquality().hash(algorithmScores),reason,recommendationScore);
...
abstract mixin class $FeedSuggestionDataCopyWith<$Res>  {
  factory $FeedSuggestionDataCopyWith(FeedSuggestionData value, $Res Function(FeedSuggestionData) _then) = _$FeedSuggestionDataCopyWithImpl;
@useResult
$Res call({
 FeedData feed, Map<String, double>? algorithmScores, String? reason, double? recommendationScore
});
...
/// Create a copy of FeedSuggestionData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? feed = null,Object? algorithmScores = freezed,Object? reason = freezed,Object? recommendationScore = freezed,}) {
...
as Map<String, double>?,reason: freezed == reason ? _self.reason : reason // ignore: cast_nullable_to_non_nullable
