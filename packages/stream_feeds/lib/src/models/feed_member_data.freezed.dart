...
mixin _$FeedMemberData {
 ...
 DateTime get createdAt; DateTime? get inviteAcceptedAt; DateTime? get inviteRejectedAt; String get role; FeedMemberStatus get status; DateTime get updatedAt; UserData get user; Map<String, Object?>? get custom;
/// Create a copy of FeedMemberData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeedMemberDataCopyWith<FeedMemberData> get copyWith => _$FeedMemberDataCopyWithImpl<FeedMemberData>(this as FeedMemberData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedMemberData&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.inviteAcceptedAt, inviteAcceptedAt) || other.inviteAcceptedAt == inviteAcceptedAt)&&(identical(other.inviteRejectedAt, inviteRejectedAt) || other.inviteRejectedAt == inviteRejectedAt)&&(identical(other.role, role) || other.role == role)&&(identical(other.status, status) || other.status == status)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.user, user) || other.user == user)&&const DeepCollectionEquality().equals(other.custom, custom));
}


@override
int get hashCode => Object.hash(runtimeType,createdAt,inviteAcceptedAt,inviteRejectedAt,role,status,updatedAt,user,const DeepCollectionEquality().hash(custom));
...
abstract mixin class $FeedMemberDataCopyWith<$Res>  {
  factory $FeedMemberDataCopyWith(FeedMemberData value, $Res Function(FeedMemberData) _then) = _$FeedMemberDataCopyWithImpl;
@useResult
$Res call({
 DateTime createdAt, DateTime? inviteAcceptedAt, DateTime? inviteRejectedAt, String role, FeedMemberStatus status, DateTime updatedAt, UserData user, Map<String, Object?>? custom
});
...
/// Create a copy of FeedMemberData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? inviteAcceptedAt = freezed,Object? inviteRejectedAt = freezed,Object? role = null,Object? status = null,Object? updatedAt = null,Object? user = null,Object? custom = freezed,}) {
