...
mixin _$UserData {
 ...
 bool get banned; List<String> get blockedUserIds; DateTime get createdAt; DateTime? get deactivatedAt; DateTime? get deletedAt; String get id; String? get image; String? get language; DateTime? get lastActive; String? get name; bool get online; DateTime? get revokeTokensIssuedBefore; String get role; List<String> get teams; DateTime get updatedAt; Map<String, Object?> get custom;
...
@override
int get hashCode => Object.hash(runtimeType,banned,const DeepCollectionEquality().hash(blockedUserIds),createdAt,deactivatedAt,deletedAt,id,image,language,lastActive,name,online,revokeTokensIssuedBefore,role,const DeepCollectionEquality().hash(teams),updatedAt,const DeepCollectionEquality().hash(custom));
...
@useResult
$Res call({
 bool banned, List<String> blockedUserIds, DateTime createdAt, DateTime? deactivatedAt, DateTime? deletedAt, String id, String? image, String? language, DateTime? lastActive, String? name, bool online, DateTime? revokeTokensIssuedBefore, String role, List<String> teams, DateTime updatedAt, Map<String, Object?> custom
});
...
/// Create a copy of UserData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? banned = null,Object? blockedUserIds = null,Object? createdAt = null,Object? deactivatedAt = freezed,Object? deletedAt = freezed,Object? id = null,Object? image = freezed,Object? language = freezed,Object? lastActive = freezed,Object? name = freezed,Object? online = null,Object? revokeTokensIssuedBefore = freezed,Object? role = null,Object? teams = null,Object? updatedAt = null,Object? custom = null,}) {
  return _then(UserData(
banned: null == banned ? _self.banned : banned // ignore: cast_nullable_to_non_nullable
