...
class ActivityDeletedEvent {
  ...
  static ActivityDeletedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ActivityDeletedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.activity.deleted")!,
  ...
  static List<ActivityDeletedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityDeletedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityDeletedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is ActivityDeletedEvent &&
