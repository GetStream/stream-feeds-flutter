...
class CommentUpdatedEvent {
  ...
  static CommentUpdatedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CommentUpdatedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.comment.updated")!,
  ...
  static List<CommentUpdatedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <CommentUpdatedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentUpdatedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  bool operator ==(Object other) {
    ...
    return other is CommentUpdatedEvent &&
