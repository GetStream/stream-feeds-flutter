...
class CommentAddedEvent {
  ...
  static CommentAddedEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CommentAddedEvent(
        ...
        type: mapValueOfType<String>(json, r'type', "feeds.comment.added")!,
  ...
  static List<CommentAddedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <CommentAddedEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentAddedEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
