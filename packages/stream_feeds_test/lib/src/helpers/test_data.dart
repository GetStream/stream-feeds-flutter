...
FeedResponse createDefaultFeedResponse({
  ...
  Location? location,
  FeedResponseVisibility visibility = FeedResponseVisibility.public,
}) {
  return FeedResponse(
    id: id,
    groupId: groupId,
...
FeedsReactionGroupResponse createDefaultFeedsReactionGroupResponse({
  int count = 1,
  DateTime? firstReactionAt,
  DateTime? lastReactionAt,
}) {
  return FeedsReactionGroupResponse(
    count: count,
    firstReactionAt: firstReactionAt ?? DateTime(2021, 1, 1),
    lastReactionAt: lastReactionAt ?? DateTime(2021, 2, 1),
  );
}
