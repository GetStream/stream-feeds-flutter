...
import 'stream_poll_creator_widget.dart';
...
/// {@endtemplate}
Future<CreatePollState?> showStreamPollCreatorDialog({
          ...
          return TextButton(
            onPressed: isValid
                ? () {
                    ...
                    return Navigator.of(context).pop(_controller.value);
                  }
                : null,
            style: TextButton.styleFrom(
              textStyle: theme.headlineBold,
