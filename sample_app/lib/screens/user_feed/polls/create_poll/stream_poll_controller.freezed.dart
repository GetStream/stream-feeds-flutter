...
class _PollValidationErrorDuplicateOptions implements PollValidationError {
  const _PollValidationErrorDuplicateOptions(final  List<PollOptionInputState> options): _options = options;
  

 final  List<PollOptionInputState> _options;
...
_$PollValidationErrorDuplicateOptionsCopyWith<_PollValidationErrorDuplicateOptions> get copyWith => __$PollValidationErrorDuplicateOptionsCopyWithImpl<_PollValidationErrorDuplicateOptions>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PollValidationErrorDuplicateOptions&&const DeepCollectionEquality().equals(other._options, _options));
}
...
abstract mixin class _$PollValidationErrorDuplicateOptionsCopyWith<$Res> implements $PollValidationErrorCopyWith<$Res> {
  factory _$PollValidationErrorDuplicateOptionsCopyWith(_PollValidationErrorDuplicateOptions value, $Res Function(_PollValidationErrorDuplicateOptions) _then) = __$PollValidationErrorDuplicateOptionsCopyWithImpl;
@useResult
$Res call({
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PollValidationErrorNameRangeCopyWith<_PollValidationErrorNameRange> get copyWith => __$PollValidationErrorNameRangeCopyWithImpl<_PollValidationErrorNameRange>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PollValidationErrorNameRange&&(identical(other.name, name) || other.name == name)&&(identical(other.range, range) || other.range == range));
}
...
abstract mixin class _$PollValidationErrorNameRangeCopyWith<$Res> implements $PollValidationErrorCopyWith<$Res> {
  factory _$PollValidationErrorNameRangeCopyWith(_PollValidationErrorNameRange value, $Res Function(_PollValidationErrorNameRange) _then) = __$PollValidationErrorNameRangeCopyWithImpl;
@useResult
$Res call({
 String name, Range<int> range
});
...
/// Create a copy of PollValidationError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? name = null,Object? range = null,}) {
...
class _PollValidationErrorOptionsRange implements PollValidationError {
  const _PollValidationErrorOptionsRange(final  List<PollOptionInputState> options, {required this.range}): _options = options;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PollValidationErrorOptionsRangeCopyWith<_PollValidationErrorOptionsRange> get copyWith => __$PollValidationErrorOptionsRangeCopyWithImpl<_PollValidationErrorOptionsRange>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PollValidationErrorOptionsRange&&const DeepCollectionEquality().equals(other._options, _options)&&(identical(other.range, range) || other.range == range));
}
...
abstract mixin class _$PollValidationErrorOptionsRangeCopyWith<$Res> implements $PollValidationErrorCopyWith<$Res> {
  factory _$PollValidationErrorOptionsRangeCopyWith(_PollValidationErrorOptionsRange value, $Res Function(_PollValidationErrorOptionsRange) _then) = __$PollValidationErrorOptionsRangeCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of PollValidationError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? options = null,Object? range = null,}) {
  return _then(_PollValidationErrorOptionsRange(
null == options ? _self._options : options // ignore: cast_nullable_to_non_nullable
as List<PollOptionInputState>,range: null == range ? _self.range : range // ignore: cast_nullable_to_non_nullable
as Range<int>,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PollValidationErrorMaxVotesAllowedCopyWith<_PollValidationErrorMaxVotesAllowed> get copyWith => __$PollValidationErrorMaxVotesAllowedCopyWithImpl<_PollValidationErrorMaxVotesAllowed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PollValidationErrorMaxVotesAllowed&&(identical(other.maxVotesAllowed, maxVotesAllowed) || other.maxVotesAllowed == maxVotesAllowed)&&(identical(other.range, range) || other.range == range));
}
...
abstract mixin class _$PollValidationErrorMaxVotesAllowedCopyWith<$Res> implements $PollValidationErrorCopyWith<$Res> {
  factory _$PollValidationErrorMaxVotesAllowedCopyWith(_PollValidationErrorMaxVotesAllowed value, $Res Function(_PollValidationErrorMaxVotesAllowed) _then) = __$PollValidationErrorMaxVotesAllowedCopyWithImpl;
@useResult
$Res call({
 int maxVotesAllowed, Range<int> range
});
...
/// Create a copy of PollValidationError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? maxVotesAllowed = null,Object? range = null,}) {
